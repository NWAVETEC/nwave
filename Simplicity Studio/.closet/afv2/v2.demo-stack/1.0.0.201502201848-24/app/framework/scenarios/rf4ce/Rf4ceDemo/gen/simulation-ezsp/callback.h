 ...
 *
 * This function is called by the RF4CE MSO plugin when a User Control Repeated
 * message is received by the device.
 *
 * @param commandCode The HDMI CEC operand [UI Command].  Ver.: always
 * @param commandPayload The additional operands, if any, required by the HDMI
 ...
 *
 * This function is called by the RF4CE MSO plugin when a User Control Released
 * message is received by the device.
 *
 * @param commandCode The HDMI CEC operand [UI Command].  Ver.: always
 */
 ...
 *
 * This function is called by the RF4CE MSO plugin when a Set Attribute Request
 * message is received by the device.
 *
 * @param pairingIndex The index of the pairing entry.  Ver.: always
 ...
 *
 * This function is called by the RF4CE MSO plugin when a Set Attribute Response
 * message is received by the device.
 *
 * @param attributeId The attribute identifier.  Ver.: always
 * @param index The index of the element to store.  Ver.: always
 ...
 *
 * This function is called by the RF4CE MSO plugin when a Get Attribute Request
 * message is received by the device.
 *
 * @param pairingIndex The index of the pairing entry.  Ver.: always
 * @param attributeId The attribute identifier.  Ver.: always
 * @param index The index of the element to retrieve.  Ver.: always
 * @param valueLen The length in octets of the requested attribute field.  Ver.:
 * always
 * @param value The value of the attribute element.  Ver.: always
 */
 ...
 *
 * This function is called by the RF4CE MSO plugin when a Get Attribute Response
 * message is received by the device.
 *
 * @param attributeId The attribute identifier.  Ver.: always
 * @param index The index of the element to retrieve.  Ver.: always
 ...
 *
 * This function is called by the RF4CE Profile plugin when an discovery request
 * is received from a for the Remote Control 1.1 profile.
 *
 ...
 *
 * This function is called by the RF4CE Profile plugin when an discovery request
 * is received from a node for the MSO profile.
 *
 * @param ieeeAddr The IEEE address of the requesting device.  Ver.: always
 * @param nodeCapabilities The capabilities of the requesting device.  Ver.:
 * always
 ...
 *
 * This function is called by the RF4CE Profile plugin when an discovery request
 * is received from a node for the GDP profile.
 *
 * @param ieeeAddr The IEEE address of the requesting device.  Ver.: always
 * @param nodeCapabilities The capabilities of the requesting device.  Ver.:
 * always
 ...
 *
 * This function is called by the RF4CE Profile plugin when an discovery
 * response is received from a node that supports the GDP profile.
 *
 * @param atCapacity TRUE if the node sending the discovery response has no free
 * entry in its pairing table, FALSE otherwise.  Ver.: always
 * @param channel The channel on which the discovery response was received. 
 ...
 *
 * This function is called by the RF4CE Profile plugin when an a pair request is
 * received from a node that supports the Remote Control 1.1 profile.
 *
 ...
 *
 * This function is called by the RF4CE Profile plugin when an a pair request is
 * received from a node that supports the MSO profile.
 *
 * @param status An ::EmberStatus value indicating whether the pairing is a new
 * pairing, a duplicate or if the pairing table is full.  Ver.: always
 * @param pairingIndex The index of the entry that will be used by the stack for
...
/** @brief User Control Repeated
 *
 * This function is called by the RF4CE ZRC plugin when a User Control Repeated
 * message is received by the device.
 *
 * @param commandCode The HDMI CEC operand [UI Command].  Ver.: always
 * @param commandPayload The additional operands, if any, required by the HDMI
...
/** @brief User Control Released
 *
 * This function is called by the RF4CE ZRC plugin when a User Control Released
 * message is received by the device.
 *
 * @param commandCode The HDMI CEC operand [UI Command].  Ver.: always
 */
