...
/** @brief <b>zcl drlc lce [eventId:4] [start:4] [duration:2] [event control:1] </b>
 ...
 *     - event control - INT8U - Control byte for the load control event
 */
...
/** @brief <b>zcl drlc gse [startTime:4] [numberOfEvents:1] </b>
