...
PGM_P const pluginCustomEzspReportsOnCommandArguments[] = {
  "The time.",
  NULL
};

PGM_P const pluginCustomEzspSetModeCommandArguments[] = {
  "The power mode.",
  NULL
};

PGM_P const pluginCustomEzspSetTokenCommandArguments[] = {
  "The node type.",
  "The node id.",
  "The pan id.",
  NULL
...
PGM_P const pluginCustomEzspRemClusterCommandArguments[] = {
  "The cluster id.",
  NULL
};

PGM_P const pluginCustomEzspAddClusterCommandArguments[] = {
  "The cluster id.",
  NULL
};

EmberCommandEntry pluginCustomEzspCommands[] = {
...
EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("custom-ezsp", pluginCustomEzspCommands, ""),
  emberCommandEntryTerminator()
};
