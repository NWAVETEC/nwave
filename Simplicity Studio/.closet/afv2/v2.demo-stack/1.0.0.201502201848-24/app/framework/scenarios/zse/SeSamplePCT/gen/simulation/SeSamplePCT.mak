...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/zse/SeSamplePCT/gen/simulation
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/zse/SeSamplePCT
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSamplePCT.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSamplePCT_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSamplePCT_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/SeSamplePCT_callbacks.c \
  ...
  app/framework/plugin/drlc/demand-response-load-control.c \
  app/framework/plugin/drlc/load-control-event-table.c \
  app/framework/plugin/drlc/drlc-cli.c \
  app/framework/plugin/drlc/load-control-event-table-soc.c \
  app/framework/plugin/esi-management/esi-management.c \
  ...
  app/framework/plugin/price-client/price-client-cli.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/SeSamplePCT-simulation
...
APP_FILE= $(OUTPUT_DIR)/SeSamplePCT
