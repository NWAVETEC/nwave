...
#define GENERATED_ATTRIBUTES { \
    ...
    { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE|ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_CLIENT), { (int8u*)&(minMaxDefaults[2]) } }, /* 2 / Demand Response and Load Control / utility enrollment group*/\
    { 0x0001, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE|ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_CLIENT), { (int8u*)&(minMaxDefaults[3]) } }, /* 3 / Demand Response and Load Control / start randomize minutes*/\
    { 0x0002, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE|ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_CLIENT), { (int8u*)&(minMaxDefaults[4]) } }, /* 4 / Demand Response and Load Control / stop randomize minutes*/\
    { 0x0003, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE|ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_CLIENT), { (int8u*)&(minMaxDefaults[5]) } }, /* 5 / Demand Response and Load Control / device class value*/\
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_CLIENT|ATTRIBUTE_MASK_SINGLETON), { (int8u*)&(minMaxDefaults[6]) } }, /* 6 / Key Establishment / key establishment suite (client)*/\
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX|ATTRIBUTE_MASK_SINGLETON), { (int8u*)&(minMaxDefaults[7]) } }, /* 7 / Key Establishment / key establishment suite (server)*/\
  }
...
#define GENERATED_CLUSTERS { \
    ...
    { 0x000A, (EmberAfAttributeMetadata*)&(generatedAttributes[2]), 0, 0, (CLUSTER_MASK_CLIENT), NULL,  },    \
    ...
    { 0x0701, (EmberAfAttributeMetadata*)&(generatedAttributes[2]), 4, 5, (CLUSTER_MASK_CLIENT| CLUSTER_MASK_INIT_FUNCTION), emberAfFuncArrayDemandResponseLoadControlClusterClient, },    \
    { 0x0800, (EmberAfAttributeMetadata*)&(generatedAttributes[6]), 1, 0, (CLUSTER_MASK_CLIENT| CLUSTER_MASK_ATTRIBUTE_CHANGED_FUNCTION| CLUSTER_MASK_DEFAULT_RESPONSE_FUNCTION| CLUSTER_MASK_MESSAGE_SENT_FUNCTION| CLUSTER_MASK_PRE_ATTRIBUTE_CHANGED_FUNCTION), emberAfFuncArrayKeyEstablishmentClusterClient, },    \
    { 0x0800, (EmberAfAttributeMetadata*)&(generatedAttributes[7]), 1, 0, (CLUSTER_MASK_SERVER| CLUSTER_MASK_INIT_FUNCTION| CLUSTER_MASK_ATTRIBUTE_CHANGED_FUNCTION| CLUSTER_MASK_DEFAULT_RESPONSE_FUNCTION| CLUSTER_MASK_MESSAGE_SENT_FUNCTION| CLUSTER_MASK_PRE_ATTRIBUTE_CHANGED_FUNCTION), emberAfFuncArrayKeyEstablishmentClusterServer, },    \
  }


// Endpoint types
#define GENERATED_ENDPOINT_TYPES {        \
    { (EmberAfCluster*)&(generatedClusters[0]), 6, 5 }, \
  }
