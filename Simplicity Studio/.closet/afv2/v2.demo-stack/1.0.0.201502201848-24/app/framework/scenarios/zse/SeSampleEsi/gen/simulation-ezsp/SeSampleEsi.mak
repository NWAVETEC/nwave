...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/zse/SeSampleEsi/gen/simulation-ezsp
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/zse/SeSampleEsi
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSampleEsi.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSampleEsi_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/SeSampleEsi_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/SeSampleEsi_callbacks.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/SeSampleEsi-simulation-ezsp
...
APP_FILE= $(OUTPUT_DIR)/SeSampleEsi
