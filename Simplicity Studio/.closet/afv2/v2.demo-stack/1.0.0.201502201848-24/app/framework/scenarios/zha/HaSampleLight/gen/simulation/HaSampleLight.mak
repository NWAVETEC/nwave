...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/zha/HaSampleLight/gen/simulation
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/zha/HaSampleLight
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleLight.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleLight_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleLight_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/HaSampleLight_callbacks.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/HaSampleLight-simulation
...
APP_FILE= $(OUTPUT_DIR)/HaSampleLight
