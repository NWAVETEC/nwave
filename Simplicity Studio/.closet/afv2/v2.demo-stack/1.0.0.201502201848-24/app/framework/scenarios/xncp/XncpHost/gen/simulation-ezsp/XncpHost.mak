...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/xncp/XncpHost/gen/simulation-ezsp
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/xncp/XncpHost
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/XncpHost.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/XncpHost_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/XncpHost_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/XncpHost_callbacks.c \
  ...
  app/framework/plugin/custom-ezsp/custom-ezsp.c \
  app/framework/plugin/custom-ezsp/custom-ezsp-cli.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/XncpHost-simulation-ezsp
