...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/zll/ZllSampleLight/gen/simulation
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/zll/ZllSampleLight
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/ZllSampleLight.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/ZllSampleLight_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/ZllSampleLight_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/ZllSampleLight_callbacks.c \
  ...
  app/framework/plugin/groups-server/groups-server-cli.c \
  ...
  app/framework/plugin/idle-sleep/idle-sleep-soc.c \
  ...
  app/framework/plugin/scenes/scenes-cli.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/ZllSampleLight-simulation
...
APP_FILE= $(OUTPUT_DIR)/ZllSampleLight
...
LIBRARIES=\
 ...
 build/packet-validate-library-unix-gcc-simulation-simulation-debug_off/packet-validate-library.a \
 ...
 build/zigbee-pro-stack-unix-gcc-simulation-simulation-debug_off/zigbee-pro-stack.a \
 build/zll-library-unix-gcc-simulation-simulation-debug_off/zll-library.a \
