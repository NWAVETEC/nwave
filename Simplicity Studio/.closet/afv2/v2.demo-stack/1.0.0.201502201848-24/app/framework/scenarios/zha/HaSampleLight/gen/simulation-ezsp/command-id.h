...
#define ZCL_PUBLISH_TARIFF_INFORMATION_COMMAND_ID 0x04    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_PRICE_MATRIX_COMMAND_ID 0x05    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_BLOCK_THRESHOLDS_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_C_O2_VALUE_COMMAND_ID 0x07    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_TIER_LABELS_COMMAND_ID 0x08    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_BILLING_PERIOD_COMMAND_ID 0x09    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_CONSOLIDATED_BILL_COMMAND_ID 0x0A    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_CPP_EVENT_COMMAND_ID 0x0B    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_CREDIT_PAYMENT_COMMAND_ID 0x0C    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_CURRENCY_CONVERSION_COMMAND_ID 0x0D    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CANCEL_TARIFF_COMMAND_ID 0x0E    // Ver.: since se-1.2a-14-0256-03
...
#define ZCL_GET_TARIFF_INFORMATION_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_PRICE_MATRIX_COMMAND_ID 0x07    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_BLOCK_THRESHOLDS_COMMAND_ID 0x08    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_C_O2_VALUE_COMMAND_ID 0x09    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_TIER_LABELS_COMMAND_ID 0x0A    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_BILLING_PERIOD_COMMAND_ID 0x0B    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_CONSOLIDATED_BILL_COMMAND_ID 0x0C    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CPP_EVENT_RESPONSE_COMMAND_ID 0x0D    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_CREDIT_PAYMENT_COMMAND_ID 0x0E    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_CURRENCY_CONVERSION_COMMAND_COMMAND_ID 0x0F    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_TARIFF_CANCELLATION_COMMAND_ID 0x10    // Ver.: since se-1.2a-14-0256-03
...
#define ZCL_SCHEDULE_SNAPSHOT_RESPONSE_COMMAND_ID 0x04    // Ver.: since se-1.2a-14-0256-03
#define ZCL_TAKE_SNAPSHOT_RESPONSE_COMMAND_ID 0x05    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_SNAPSHOT_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_SAMPLED_DATA_RESPONSE_COMMAND_ID 0x07    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CONFIGURE_MIRROR_COMMAND_ID 0x08    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CONFIGURE_NOTIFICATION_SCHEME_COMMAND_ID 0x09    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CONFIGURE_NOTIFICATION_FLAGS_COMMAND_ID 0x0A    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_NOTIFIED_MESSAGE_COMMAND_ID 0x0B    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SUPPLY_STATUS_RESPONSE_COMMAND_ID 0x0C    // Ver.: since se-1.2a-14-0256-03
#define ZCL_START_SAMPLING_RESPONSE_COMMAND_ID 0x0D    // Ver.: since se-1.2a-14-0256-03
...
#define ZCL_SCHEDULE_SNAPSHOT_COMMAND_ID 0x04    // Ver.: since se-1.2a-14-0256-03
#define ZCL_TAKE_SNAPSHOT_COMMAND_ID 0x05    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_SNAPSHOT_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03
#define ZCL_START_SAMPLING_COMMAND_ID 0x07    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_SAMPLED_DATA_COMMAND_ID 0x08    // Ver.: since se-1.2a-14-0256-03
#define ZCL_MIRROR_REPORT_ATTRIBUTE_RESPONSE_COMMAND_ID 0x09    // Ver.: since se-1.2a-14-0256-03
#define ZCL_RESET_LOAD_LIMIT_COUNTER_COMMAND_ID 0x0A    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CHANGE_SUPPLY_COMMAND_ID 0x0B    // Ver.: since se-1.2a-14-0256-03
#define ZCL_LOCAL_CHANGE_SUPPLY_COMMAND_ID 0x0C    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SET_SUPPLY_STATUS_COMMAND_ID 0x0D    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SET_UNCONTROLLED_FLOW_THRESHOLD_COMMAND_ID 0x0E    // Ver.: since se-1.2a-14-0256-03
...
#define ZCL_DISPLAY_PROTECTED_MESSAGE_COMMAND_ID 0x02    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CANCEL_ALL_MESSAGES_COMMAND_ID 0x03    // Ver.: since se-1.2a-14-0256-03

// Client to server
#define ZCL_GET_LAST_MESSAGE_COMMAND_ID 0x00    // Ver.: always
#define ZCL_MESSAGE_CONFIRMATION_COMMAND_ID 0x01    // Ver.: always
#define ZCL_GET_MESSAGE_CANCELLATION_COMMAND_ID 0x02    // Ver.: since se-1.2a-14-0256-03
...
// Server to client
#define ZCL_PUBLISH_PREPAY_SNAPSHOT_COMMAND_ID 0x01    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CHANGE_PAYMENT_MODE_RESPONSE_COMMAND_ID 0x02    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CONSUMER_TOP_UP_RESPONSE_COMMAND_ID 0x03    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_TOP_UP_LOG_COMMAND_ID 0x05    // Ver.: since se-1.2a-14-0256-03
#define ZCL_PUBLISH_DEBT_LOG_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03

// Client to server
#define ZCL_SELECT_AVAILABLE_EMERGENCY_CREDIT_COMMAND_ID 0x00    // Ver.: always
#define ZCL_CHANGE_DEBT_COMMAND_ID 0x02    // Ver.: since se-1.2a-14-0256-03
#define ZCL_EMERGENCY_CREDIT_SETUP_COMMAND_ID 0x03    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CONSUMER_TOP_UP_COMMAND_ID 0x04    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CREDIT_ADJUSTMENT_COMMAND_ID 0x05    // Ver.: since se-1.2a-14-0256-03
#define ZCL_CHANGE_PAYMENT_MODE_COMMAND_ID 0x06    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_PREPAY_SNAPSHOT_COMMAND_ID 0x07    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_TOP_UP_LOG_COMMAND_ID 0x08    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SET_LOW_CREDIT_WARNING_LEVEL_COMMAND_ID 0x09    // Ver.: since se-1.2a-14-0256-03
#define ZCL_GET_DEBT_REPAYMENT_LOG_COMMAND_ID 0x0A    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SET_MAXIMUM_CREDIT_LIMIT_COMMAND_ID 0x0B    // Ver.: since se-1.2a-14-0256-03
#define ZCL_SET_OVERALL_DEBT_CAP_COMMAND_ID 0x0C    // Ver.: since se-1.2a-14-0256-03
