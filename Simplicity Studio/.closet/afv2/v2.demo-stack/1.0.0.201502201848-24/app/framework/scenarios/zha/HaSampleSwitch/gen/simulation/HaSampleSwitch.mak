...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/zha/HaSampleSwitch/gen/simulation
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/zha/HaSampleSwitch
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleSwitch.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleSwitch_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/HaSampleSwitch_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/HaSampleSwitch_callbacks.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/HaSampleSwitch-simulation
...
APP_FILE= $(OUTPUT_DIR)/HaSampleSwitch
...
LIBRARIES=\
 ...
 build/zigbee-pro-leaf-stack-unix-gcc-simulation-simulation-debug_off/zigbee-pro-leaf-stack.a \
