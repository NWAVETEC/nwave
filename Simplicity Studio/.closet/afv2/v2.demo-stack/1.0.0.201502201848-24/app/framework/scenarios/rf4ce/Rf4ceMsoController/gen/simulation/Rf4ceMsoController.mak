...
APP_BUILDER_OUTPUT_DIRECTORY=app/framework/scenarios/rf4ce/Rf4ceMsoController/gen/simulation
# Makefile Variable replacement by sample-apps-regenerate.pl
APP_CALLBACK_FILE_DIRECTORY=app/framework/scenarios/rf4ce/Rf4ceMsoController
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/Rf4ceMsoController.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/Rf4ceMsoController_endpoint_config.h
...
DEFINES= \
  ...
  -DGENERATED_TOKEN_HEADER=\"$(APP_BUILDER_OUTPUT_DIRECTORY)/Rf4ceMsoController_tokens.h\" \
...
APPLICATION_FILES= \
  ...
  $(APP_CALLBACK_FILE_DIRECTORY)/Rf4ceMsoController_callbacks.c \
...
# Makefile Variable replacement by sample-apps-regenerate.pl
OUTPUT_DIR=build/af-test-apps/Rf4ceMsoController-simulation
...
APP_FILE= $(OUTPUT_DIR)/Rf4ceMsoController
