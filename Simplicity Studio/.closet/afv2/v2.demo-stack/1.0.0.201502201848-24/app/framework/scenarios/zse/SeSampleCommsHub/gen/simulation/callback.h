 ...
 *
 * This function is called by the Meter Snapshot server plugin whenever a
 * GetSnapshot command is received. A plugin implementing backhaul functionality
 * for the snapshot mechanism should proceed to retrieve the snapshot and send a
 * PublishSnapshot command to the requesting client.
 *
 * @param srcEndpoint   Ver.: always
 * @param dstEndpoint   Ver.: always
 * @param dest   Ver.: always
 ...
 * are not required to notify clients of tunnel closures, so applications cannot
 * rely on this callback being called for all tunnels.
 *
