...
// Top level macros
#define EMBER_AF_DEVICE_NAME "server-3588"
...
#define GENERATED_EXI_GRAMMAR "app/afv6/sample-apps/server-3588/gen/afv6-exi-grammar.h"
#define GENERATED_EXI_QNAMES "app/afv6/sample-apps/server-3588/gen/afv6-exi-qname.h"
#define GENERATED_EXI_TYPES "app/afv6/sample-apps/server-3588/gen/afv6-exi-types.h"


// Generated plugin macros


// Use this macro to check if plugin billing-server is included
#define EMBER_AF_PLUGIN_BILLING_SERVER
...
// Use this macro to check if plugin der-server is included
#define EMBER_AF_PLUGIN_DER_SERVER
...
// Use this macro to check if plugin prepayment-server is included
#define EMBER_AF_PLUGIN_PREPAYMENT_SERVER

// Use this macro to check if plugin pricing-server is included
#define EMBER_AF_PLUGIN_PRICING_SERVER
