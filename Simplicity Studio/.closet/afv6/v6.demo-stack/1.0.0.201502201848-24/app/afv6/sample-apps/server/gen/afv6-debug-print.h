...
#define EMBER_AF_PRINT_PLUGIN_CLI 0x0001
#define EMBER_AF_PRINT_PLUGIN_COMMON 0x0002
#define EMBER_AF_PRINT_PLUGIN_EXI 0x0004
#define EMBER_AF_PRINT_PLUGIN_HTTP 0x0008
#define EMBER_AF_PRINT_PLUGIN_DRLC_COMMON 0x0010
#define EMBER_AF_PRINT_PLUGIN_SUBSCRIPTION_SERVER 0x0020
#define EMBER_AF_PRINT_PLUGIN_TIME_SERVER 0x0040
#define EMBER_AF_PRINT_PLUGIN_METERING_SERVER 0x0080
#define EMBER_AF_PRINT_PLUGIN_METERING_COMMON 0x0101
#define EMBER_AF_PRINT_PLUGIN_DRLC_SERVER 0x0102
#define EMBER_AF_PRINT_PLUGIN_SERVER 0x0104
#define EMBER_AF_PRINT_PLUGIN_MESSAGING_SERVER 0x0108
#define EMBER_AF_PRINT_PLUGIN_MESSAGING_COMMON 0x0110
#define EMBER_AF_PRINT_PLUGIN_FUNCTION_SET_ASSIGNMENTS_SERVER 0x0120
#define EMBER_AF_PRINT_PLUGIN_PREPAYMENT_SERVER 0x0140
#define EMBER_AF_PRINT_PLUGIN_POWER_STATUS_SERVER 0x0180
#define EMBER_AF_PRINT_PLUGIN_POWER_STATUS_COMMON 0x0201
#define EMBER_AF_PRINT_PLUGIN_PRICING_SERVER 0x0202
#define EMBER_AF_PRINT_PLUGIN_SOFTWARE_DOWNLOAD_SERVER 0x0204
#define EMBER_AF_PRINT_PLUGIN_NETSTAT_SERVER 0x0208
#define EMBER_AF_PRINT_PLUGIN_BILLING_SERVER 0x0210
#define EMBER_AF_PRINT_PLUGIN_DER_SERVER 0x0220
#define EMBER_AF_PRINT_CORE 0x0240
#define EMBER_AF_PRINT_DEBUG 0x0280
#define EMBER_AF_PRINT_APP 0x0301
#define EMBER_AF_PRINT_BITS { 0xFF, 0xFF, 0xFF, 0x01 }
#define EMBER_AF_PRINT_NAMES { \
  ...
  "Netstat Server",\
  "Billing Server",\
  "Distributed Energy Resource (DER) Server",\
  "Core",\
  "Debug",\
  "Application",\
  NULL\
}
#define EMBER_AF_PRINT_NAME_NUMBER 25
...
// Generated functions for use within plugin Distributed Energy Resource (DER) Server
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_DER_SERVER)
#define emberAfPluginDerServerPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_DER_SERVER, __VA_ARGS__)
#define emberAfPluginDerServerPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_DER_SERVER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginDerServerFlush()
#define emberAfPluginDerServerDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_DER_SERVER) ) { x; }
#define emberAfPluginDerServerPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_DER_SERVER, (buffer), (len), (withSpace))
#define emberAfPluginDerServerPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_DER_SERVER, (buffer))
#else
#define emberAfPluginDerServerPrint(...)
#define emberAfPluginDerServerPrintln(...)
#define emberAfPluginDerServerFlush()
#define emberAfPluginDerServerDebugExec(x)
#define emberAfPluginDerServerPrintBuffer(buffer, len, withSpace)
#define emberAfPluginDerServerPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_DER_SERVER)
