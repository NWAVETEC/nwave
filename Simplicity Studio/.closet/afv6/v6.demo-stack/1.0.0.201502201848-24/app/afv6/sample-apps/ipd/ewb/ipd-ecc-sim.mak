...
DEFINES= \
  ...
  -DCONFIGURATION_HEADER=\"app/afv6/sample-apps/ipd/gen/afv6-config.h\" \
...
APPLICATION_FILES= \
  ...
  app/afv6/sample-apps/ipd/gen/afv6-uri-mapper.c \
  app/afv6/sample-apps/ipd/gen/afv6-exi-api.c \
  app/afv6/sample-apps/ipd/gen/afv6-events.c \
  app/afv6/sample-apps/ipd/gen/afv6-callback-stubs.c \
  app/afv6/sample-apps/ipd/gen/afv6-callbacks.c \
 \
...
OUTPUT_DIR= build/afv6-ipd-ecc-unix-simulation
...
APP_FILE= $(OUTPUT_DIR)/afv6-ipd-ecc
...
$(OUTPUT_DIR)/%.o: app/afv6/sample-apps/ipd/gen/%.c $(OUTPUT_DIR_CREATED)
	$(CC) $(CPPFLAGS) -c $< -o $(OUTPUT_DIR)/$(@F)
