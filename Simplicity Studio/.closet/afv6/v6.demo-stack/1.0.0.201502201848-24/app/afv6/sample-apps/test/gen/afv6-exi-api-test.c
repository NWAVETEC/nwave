...
void emberExiApiUnitTest(EmberExiGrammarSet *grammarSet, EmberExiBits *bits, int8u *outputBuffer) {
  ...
  assert(emberExiStructUnitTest("ActiveChargeReservationListLink",
                                EMBER_EXI_QNAME_ActiveChargeReservationListLink,
                                emberExiActiveChargeReservationListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargeReservationListLink",
                                EMBER_EXI_QNAME_ChargeReservationListLink,
                                emberExiChargeReservationListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Voltage",
                                EMBER_EXI_QNAME_Voltage,
                                emberExiVoltageStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ReadingQuality",
                                EMBER_EXI_QNAME_ReadingQuality,
                                emberExiReadingQualityStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("LoadShedAvailabilityListLink",
                                EMBER_EXI_QNAME_LoadShedAvailabilityListLink,
                                emberExiLoadShedAvailabilityListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ServiceCategory",
                                EMBER_EXI_QNAME_ServiceCategory,
                                emberExiServiceCategoryStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ActivePowerChargeRate",
                                EMBER_EXI_QNAME_ActivePowerChargeRate,
                                emberExiActivePowerChargeRateStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Cost",
                                EMBER_EXI_QNAME_Cost,
                                emberExiCostStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("RandomizedDateTimeInterval",
                                EMBER_EXI_QNAME_RandomizedDateTimeInterval,
                                emberExiRandomizedDateTimeIntervalStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargerLink",
                                EMBER_EXI_QNAME_ChargerLink,
                                emberExiChargerLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ChargeReservation",
                                EMBER_EXI_QNAME_ChargeReservation,
                                emberExiChargeReservationStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ChargeReservationList",
                                EMBER_EXI_QNAME_ChargeReservationList,
                                emberExiChargeReservationListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("IntervalReading",
                                EMBER_EXI_QNAME_IntervalReading,
                                emberExiIntervalReadingStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("IntervalBlock",
                                EMBER_EXI_QNAME_IntervalBlock,
                                emberExiIntervalBlockStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("IntervalBlockList",
                                EMBER_EXI_QNAME_IntervalBlockList,
                                emberExiIntervalBlockListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ReadingTypeList",
                                EMBER_EXI_QNAME_ReadingTypeList,
                                emberExiReadingTypeListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Status",
                                EMBER_EXI_QNAME_Status,
                                emberExiStatusStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("EndDeviceGroupListLink",
                                EMBER_EXI_QNAME_EndDeviceGroupListLink,
                                emberExiEndDeviceGroupListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("NetworkStatusLink",
                                EMBER_EXI_QNAME_NetworkStatusLink,
                                emberExiNetworkStatusLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("EndDeviceGroup",
                                EMBER_EXI_QNAME_EndDeviceGroup,
                                emberExiEndDeviceGroupStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargerStatus",
                                EMBER_EXI_QNAME_ChargerStatus,
                                emberExiChargerStatusStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("Charger",
                                EMBER_EXI_QNAME_Charger,
                                emberExiChargerStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("IntervalBlockListLink",
                                EMBER_EXI_QNAME_IntervalBlockListLink,
                                emberExiIntervalBlockListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("PowerFactor",
                                EMBER_EXI_QNAME_PowerFactor,
                                emberExiPowerFactorStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargerListLink",
                                EMBER_EXI_QNAME_ChargerListLink,
                                emberExiChargerListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Signature",
                                EMBER_EXI_QNAME_Signature,
                                emberExiSignatureStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("Document",
                                EMBER_EXI_QNAME_Document,
                                emberExiDocumentStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("RegistrationListLink",
                                EMBER_EXI_QNAME_RegistrationListLink,
                                emberExiRegistrationListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargeListLink",
                                EMBER_EXI_QNAME_ChargeListLink,
                                emberExiChargeListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ReadingTypeListLink",
                                EMBER_EXI_QNAME_ReadingTypeListLink,
                                emberExiReadingTypeListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ChargeList",
                                EMBER_EXI_QNAME_ChargeList,
                                emberExiChargeListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("LoadShedAvailabilityList",
                                EMBER_EXI_QNAME_LoadShedAvailabilityList,
                                emberExiLoadShedAvailabilityListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("PrepayResponse",
                                EMBER_EXI_QNAME_PrepayResponse,
                                emberExiPrepayResponseStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("NetworkStatus",
                                EMBER_EXI_QNAME_NetworkStatus,
                                emberExiNetworkStatusStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Activation",
                                EMBER_EXI_QNAME_Activation,
                                emberExiActivationStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("EndDeviceGroupList",
                                EMBER_EXI_QNAME_EndDeviceGroupList,
                                emberExiEndDeviceGroupListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
