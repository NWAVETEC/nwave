...
INCLUDES= \
  ...
  -Iapp/afv6/sample-apps/client/gen \
...
DEFINES= \
  ...
  -DCONFIGURATION_HEADER=\"app/afv6/sample-apps/client/gen/afv6-config.h\" \
...
APPLICATION_FILES= \
  ...
  app/afv6/sample-apps/client/gen/afv6-uri-mapper.c \
  app/afv6/sample-apps/client/gen/afv6-exi-api.c \
  app/afv6/sample-apps/client/gen/afv6-events.c \
  app/afv6/sample-apps/client/gen/afv6-callback-stubs.c \
  app/afv6/sample-apps/client/gen/afv6-callbacks.c \
 \
...
OUTPUT_DIR= build/afv6-client-ecc-unix-simulation
...
APP_FILE= $(OUTPUT_DIR)/afv6-client-ecc
...
$(OUTPUT_DIR)/%.o: app/afv6/sample-apps/client/gen/%.c $(OUTPUT_DIR_CREATED)
	$(CC) $(CPPFLAGS) -c $< -o $(OUTPUT_DIR)/$(@F)
