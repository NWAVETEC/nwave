...
#define EMBER_AF_CLI_COMMANDS \
  ...
  emberCommand("get_ip_interface_list", emberAfGetIpInterfaceListCommand, "v*", ""), \
  emberCommand("get_ip_interface", emberAfGetIpInterfaceCommand, "uv*", ""), \
  emberCommand("get_ip_addr_list", emberAfGetIpAddrListCommand, "uv*", ""), \
  emberCommand("get_ip_addr", emberAfGetIpAddrCommand, "uuv*", ""), \
  emberCommand("get_rpl_instance_list", emberAfGetRplInstanceListCommand, "uuv*", ""), \
  emberCommand("get_rpl_instance", emberAfGetRplInstanceCommand, "uuuv*", ""), \
  emberCommand("get_rpl_source_routes_list", emberAfGetRplSourceRoutesListCommand, "uuuv*", ""), \
  emberCommand("get_rpl_source_routes", emberAfGetRplSourceRoutesCommand, "uuuuv*", ""), \
