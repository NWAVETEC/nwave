...
#define EMBER_EXI_STRUCT EmberExiGeneratedAbstractDevice // index 1
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AbstractDevice, 2, 0, 3724, 66, 0),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedAbstractFlowReservation // index 67
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AbstractFlowReservation, 4, 6, 1726, 12, 1),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedAccountBalance // index 79
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AccountBalance, 1, 0, 3463, 24, 2),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedAccountBalanceLink // index 103
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AccountBalanceLink, 1, 0, 2380, 6, 3),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedAccountingUnit // index 109
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AccountingUnit, 0, 0, 65535, 21, 4),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedActiveBillingPeriodListLink // index 130
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveBillingPeriodListLink, 2, 0, 2404, 6, 6),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveCreditRegisterListLink // index 136
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveCreditRegisterListLink, 2, 0, 2404, 6, 7),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveDERControlListLink // index 142
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveDERControlListLink, 2, 0, 2404, 6, 8),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveEndDeviceControlListLink // index 148
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveEndDeviceControlListLink, 2, 0, 2404, 6, 9),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveFlowReservationListLink // index 154
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveFlowReservationListLink, 2, 0, 2404, 6, 10),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActivePower // index 160
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActivePower, 0, 0, 65535, 12, 11),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveProjectionReadingListLink // index 172
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveProjectionReadingListLink, 2, 0, 2404, 6, 12),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveSupplyInterruptionOverrideListLink // index 178
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveSupplyInterruptionOverrideListLink, 2, 0, 2404, 6, 13),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveTargetReadingListLink // index 184
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveTargetReadingListLink, 2, 0, 2404, 6, 14),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveTextMessageListLink // index 190
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveTextMessageListLink, 2, 0, 2404, 6, 15),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedActiveTimeTariffIntervalListLink // index 196
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveTimeTariffIntervalListLink, 2, 0, 2404, 6, 16),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedAmpereHour // index 202
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AmpereHour, 0, 0, 65535, 12, 17),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedApparentPower // index 214
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ApparentPower, 0, 0, 65535, 12, 18),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedApplianceLoadReduction // index 226
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ApplianceLoadReduction, 0, 0, 65535, 9, 19),
    EMBER_EXI_CH(type, UNSIGNED_INTEGER, 255, type),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedAppliedTargetReduction // index 235
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AppliedTargetReduction, 0, 0, 65535, 12, 21),
    EMBER_EXI_CH(type, UNSIGNED_INTEGER, 255, type),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedAssociatedDERProgramListLink // index 247
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AssociatedDERProgramListLink, 2, 0, 2404, 6, 22),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedAssociatedUsagePointLink // index 253
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AssociatedUsagePointLink, 1, 0, 2380, 6, 23),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedBillingMeterReadingBase // index 259
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingMeterReadingBase, 1, 3, 2587, 18, 24),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingPeriod // index 277
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingPeriod, 1, 0, 3463, 21, 25),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingPeriodList // index 298
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingPeriodList, 4, 0, 3706, 12, 26),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingPeriodListLink // index 310
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingPeriodListLink, 2, 0, 2404, 6, 27),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReading // index 316
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReading, 1, 5, 3274, 12, 28),
    EMBER_EXI_SUBSTRUCT_ARRAY(Charge, 0, 255, Charge, EmberExiGeneratedCharge, emberExiChargeStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReadingList // index 328
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReadingList, 3, 0, 2389, 12, 29),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReadingListLink // index 340
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReadingListLink, 2, 0, 2404, 6, 30),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReadingSet // index 346
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReadingSet, 1, 4, 3334, 12, 31),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReadingSetList // index 358
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReadingSetList, 4, 0, 3706, 12, 32),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedBillingReadingSetListLink // index 370
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_BillingReadingSetListLink, 2, 0, 2404, 6, 33),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCharge // index 376
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Charge, 0, 0, 65535, 15, 34),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_CH(kind, UNSIGNED_INTEGER, 0, kind_option),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCondition // index 391
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Condition, 0, 0, 65535, 15, 37),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConfiguration // index 406
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Configuration, 2, 0, 3724, 30, 38),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConfigurationLink // index 436
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConfigurationLink, 1, 0, 2380, 6, 39),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedConnectStatusType // index 442
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConnectStatusType, 0, 0, 65535, 12, 40),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedConsumptionTariffInterval // index 454
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConsumptionTariffInterval, 1, 0, 3463, 21, 42),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConsumptionTariffIntervalList // index 475
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConsumptionTariffIntervalList, 3, 0, 2389, 12, 43),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConsumptionTariffIntervalListLink // index 487
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConsumptionTariffIntervalListLink, 2, 0, 2404, 6, 44),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCreditRegister // index 493
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CreditRegister, 1, 3, 2275, 21, 46),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCreditRegisterList // index 514
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CreditRegisterList, 3, 0, 2389, 12, 47),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCreditRegisterListLink // index 526
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CreditRegisterListLink, 2, 0, 2404, 6, 48),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCreditTypeChange // index 532
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CreditTypeChange, 0, 0, 65535, 12, 50),
    EMBER_EXI_CH(newType, UNSIGNED_INTEGER, 255, newType),
    EMBER_EXI_CH(startTime, INTEGER, 255, startTime),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCurrentDERProgramLink // index 544
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CurrentDERProgramLink, 1, 0, 2380, 6, 53),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCurrentRMS // index 550
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CurrentRMS, 0, 0, 65535, 12, 54),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCurveData // index 562
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CurveData, 0, 0, 65535, 15, 55),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCurvePairType // index 577
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CurvePairType, 0, 0, 65535, 18, 56),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAccount // index 595
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAccount, 1, 3, 2275, 30, 57),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAccountLink // index 625
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAccountLink, 1, 0, 2380, 6, 58),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAccountList // index 631
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAccountList, 4, 0, 3706, 12, 59),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAccountListLink // index 643
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAccountListLink, 2, 0, 2404, 6, 60),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAgreement // index 649
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAgreement, 1, 3, 2275, 72, 61),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAgreementList // index 721
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAgreementList, 4, 0, 3706, 12, 62),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAgreementListLink // index 733
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAgreementListLink, 2, 0, 2404, 6, 63),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDER // index 739
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DER, 2, 0, 3724, 48, 64),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDERAvailability // index 787
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERAvailability, 2, 0, 3724, 33, 65),
    EMBER_EXI_CH(availabilityDuration, INTEGER, 1, availabilityDuration_option),
    EMBER_EXI_CH(maxChargeDuration, INTEGER, 2, maxChargeDuration_option),
    EMBER_EXI_CH(readingTime, INTEGER, 255, readingTime),
    EMBER_EXI_CH(reserveChargePercent, UNSIGNED_INTEGER, 3, reserveChargePercent_option),
    EMBER_EXI_CH(reservePercent, UNSIGNED_INTEGER, 4, reservePercent_option),
    EMBER_EXI_SUBSTRUCT_OPTION(statVArAvail, 0, 1, statVArAvail, EmberExiGeneratedReactivePower, emberExiReactivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(statWAvail, 0, 1, statWAvail, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERAvailabilityLink // index 820
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERAvailabilityLink, 1, 0, 2380, 6, 66),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERCapability // index 826
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCapability, 2, 0, 3724, 78, 67),
    EMBER_EXI_CH(modesSupported, BINARY, 255, modesSupported),
    EMBER_EXI_SUBSTRUCT(rtgA, 1, 0, rtgA, EmberExiGeneratedCurrentRMS, emberExiCurrentRMSStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgAh, 0, 1, rtgAh, EmberExiGeneratedAmpereHour, emberExiAmpereHourStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgMaxChargeRate, 0, 1, rtgMaxChargeRate, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgMaxDischargeRate, 0, 1, rtgMaxDischargeRate, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgMinPF, 0, 1, rtgMinPF, EmberExiGeneratedFixedPointType, emberExiFixedPointTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgMinPFUnder, 0, 1, rtgMinPFUnder, EmberExiGeneratedFixedPointType, emberExiFixedPointTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgVA, 0, 1, rtgVA, EmberExiGeneratedApparentPower, emberExiApparentPowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgVAr, 0, 1, rtgVAr, EmberExiGeneratedReactivePower, emberExiReactivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgVArNeg, 0, 1, rtgVArNeg, EmberExiGeneratedReactivePower, emberExiReactivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT(rtgW, 1, 0, rtgW, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(rtgWh, 0, 1, rtgWh, EmberExiGeneratedWattHour, emberExiWattHourStructDataIndex),
    EMBER_EXI_CH(type, UNSIGNED_INTEGER, 255, type),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERCapabilityLink // index 904
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCapabilityLink, 1, 0, 2380, 6, 68),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERControl // index 910
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERControl, 4, 8, 3172, 12, 69),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDERControlBase // index 922
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERControlBase, 0, 0, 65535, 63, 70),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDERControlList // index 985
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERControlList, 4, 0, 3706, 12, 71),
    EMBER_EXI_SUBSTRUCT_ARRAY(DERControl, 0, 255, DERControl, EmberExiGeneratedDERControl, emberExiDERControlStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERControlListLink // index 997
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERControlListLink, 2, 0, 2404, 6, 72),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERCurve // index 1003
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCurve, 1, 3, 2275, 36, 74),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDERCurveLink // index 1039
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCurveLink, 1, 0, 2380, 6, 75),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERCurveList // index 1045
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCurveList, 3, 0, 2389, 12, 76),
    EMBER_EXI_SUBSTRUCT_ARRAY(DERCurve, 0, 255, DERCurve, EmberExiGeneratedDERCurve, emberExiDERCurveStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERCurveListLink // index 1057
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERCurveListLink, 2, 0, 2404, 6, 77),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERLink // index 1063
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERLink, 1, 0, 2380, 6, 79),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERList // index 1069
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERList, 3, 0, 2389, 12, 80),
    EMBER_EXI_SUBSTRUCT_ARRAY(DER, 0, 255, DER, EmberExiGeneratedDER, emberExiDERStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERListLink // index 1081
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERListLink, 2, 0, 2404, 6, 81),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERProgram // index 1087
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERProgram, 1, 3, 2275, 33, 82),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDERProgramLink // index 1120
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERProgramLink, 1, 0, 2380, 6, 83),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERProgramList // index 1126
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERProgramList, 3, 0, 2389, 12, 84),
    EMBER_EXI_SUBSTRUCT_ARRAY(DERProgram, 0, 255, DERProgram, EmberExiGeneratedDERProgram, emberExiDERProgramStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERProgramListLink // index 1138
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERProgramListLink, 2, 0, 2404, 6, 85),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERSettings // index 1144
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERSettings, 2, 0, 3724, 78, 86),
    EMBER_EXI_CH(setGenConnect, BOOLEAN, 1, setGenConnect_option),
    EMBER_EXI_CH(setGradW, UNSIGNED_INTEGER, 255, setGradW),
    EMBER_EXI_SUBSTRUCT_OPTION(setMaxChargeRate, 0, 1, setMaxChargeRate, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMaxDischargeRate, 0, 1, setMaxDischargeRate, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMaxVA, 0, 1, setMaxVA, EmberExiGeneratedApparentPower, emberExiApparentPowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMaxVAr, 0, 1, setMaxVAr, EmberExiGeneratedReactivePower, emberExiReactivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMaxVArNeg, 0, 1, setMaxVArNeg, EmberExiGeneratedReactivePower, emberExiReactivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT(setMaxW, 1, 0, setMaxW, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMinPF, 0, 1, setMinPF, EmberExiGeneratedFixedPointType, emberExiFixedPointTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setMinPFUnder, 0, 1, setMinPFUnder, EmberExiGeneratedFixedPointType, emberExiFixedPointTypeStructDataIndex),
    EMBER_EXI_CH(setStorConnect, BOOLEAN, 2, setStorConnect_option),
    EMBER_EXI_SUBSTRUCT_OPTION(setVRef, 0, 1, setVRef, EmberExiGeneratedVoltageRMS, emberExiVoltageRMSStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(setVRefOfs, 0, 1, setVRefOfs, EmberExiGeneratedVoltageRMS, emberExiVoltageRMSStructDataIndex),
    EMBER_EXI_CH(updatedTime, INTEGER, 255, updatedTime),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERSettingsLink // index 1222
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERSettingsLink, 1, 0, 2380, 6, 87),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERStatus // index 1228
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERStatus, 2, 0, 3724, 57, 88),
    EMBER_EXI_SUBSTRUCT_OPTION(genConnectStatus, 0, 1, genConnectStatus, EmberExiGeneratedConnectStatusType, emberExiConnectStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(inverterStatus, 0, 1, inverterStatus, EmberExiGeneratedInverterStatusType, emberExiInverterStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(localControlModeStatus, 0, 1, localControlModeStatus, EmberExiGeneratedLocalControlModeStatusType, emberExiLocalControlModeStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(manufacturerStatus, 0, 1, manufacturerStatus, EmberExiGeneratedManufacturerStatusType, emberExiManufacturerStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(operationalModeStatus, 0, 1, operationalModeStatus, EmberExiGeneratedOperationalModeStatusType, emberExiOperationalModeStatusTypeStructDataIndex),
    EMBER_EXI_CH(readingTime, INTEGER, 255, readingTime),
    EMBER_EXI_SUBSTRUCT_OPTION(stateOfChargeStatus, 0, 1, stateOfChargeStatus, EmberExiGeneratedStateOfChargeStatusType, emberExiStateOfChargeStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(storageModeStatus, 0, 1, storageModeStatus, EmberExiGeneratedStorageModeStatusType, emberExiStorageModeStatusTypeStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(storConnectStatus, 0, 1, storConnectStatus, EmberExiGeneratedConnectStatusType, emberExiConnectStatusTypeStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERStatusLink // index 1285
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERStatusLink, 1, 0, 2380, 6, 89),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDRLCCapabilities // index 1291
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DRLCCapabilities, 0, 0, 65535, 21, 92),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDateTimeInterval // index 1312
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DateTimeInterval, 0, 0, 65535, 12, 94),
    EMBER_EXI_CH(duration, INTEGER, 255, duration),
    EMBER_EXI_CH(start, INTEGER, 255, start),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDefaultDERControl // index 1324
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DefaultDERControl, 2, 3, 3691, 12, 95),
    EMBER_EXI_SUBSTRUCT(DERControlBase, 1, 0, DERControlBase, EmberExiGeneratedDERControlBase, emberExiDERControlBaseStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDefaultDERControlLink // index 1336
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DefaultDERControlLink, 1, 0, 2380, 6, 96),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDemandResponseProgram // index 1342
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DemandResponseProgram, 1, 3, 2275, 30, 97),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDemandResponseProgramLink // index 1372
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DemandResponseProgramLink, 1, 0, 2380, 6, 98),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDemandResponseProgramList // index 1378
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DemandResponseProgramList, 4, 0, 3706, 12, 99),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDemandResponseProgramListLink // index 1390
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DemandResponseProgramListLink, 2, 0, 2404, 6, 100),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceCapability // index 1396
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceCapability, 1, 10, 2008, 24, 101),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceCapabilityLink // index 1420
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceCapabilityLink, 1, 0, 2380, 6, 102),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceInformation // index 1426
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceInformation, 1, 0, 3463, 54, 104),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceInformationLink // index 1480
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceInformationLink, 1, 0, 2380, 6, 105),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceStatus // index 1486
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceStatus, 1, 0, 3463, 30, 106),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceStatusLink // index 1516
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceStatusLink, 1, 0, 2380, 6, 107),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDrResponse // index 1522
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DrResponse, 1, 4, 3529, 39, 108),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDutyCycle // index 1561
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DutyCycle, 0, 0, 65535, 9, 110),
    EMBER_EXI_CH(normalValue, UNSIGNED_INTEGER, 255, normalValue),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEndDevice // index 1570
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDevice, 2, 11, 1, 36, 111),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceControl // index 1606
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceControl, 4, 8, 3172, 48, 112),
    EMBER_EXI_SUBSTRUCT_OPTION(ApplianceLoadReduction, 0, 1, ApplianceLoadReduction, EmberExiGeneratedApplianceLoadReduction, emberExiApplianceLoadReductionStructDataIndex),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceControlList // index 1654
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceControlList, 4, 0, 3706, 12, 113),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceControlListLink // index 1666
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceControlListLink, 2, 0, 2404, 6, 114),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceLink // index 1672
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceLink, 1, 0, 2380, 6, 115),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceList // index 1678
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceList, 4, 0, 3706, 12, 116),
    EMBER_EXI_SUBSTRUCT_ARRAY(EndDevice, 0, 255, EndDevice, EmberExiGeneratedEndDevice, emberExiEndDeviceStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceListLink // index 1690
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceListLink, 2, 0, 2404, 6, 117),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEnvironmentalCost // index 1696
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EnvironmentalCost, 0, 0, 65535, 18, 118),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedError // index 1714
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Error, 0, 0, 65535, 12, 119),
    EMBER_EXI_CH(maxRetryDuration, UNSIGNED_INTEGER, 0, maxRetryDuration_option),
    EMBER_EXI_CH(reasonCode, UNSIGNED_INTEGER, 255, reasonCode),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEvent // index 1726
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Event, 4, 3, 3502, 21, 120),
    EMBER_EXI_CH(creationTime, INTEGER, 255, creationTime),
    EMBER_EXI_SUBSTRUCT(EventStatus, 1, 0, EventStatus, EmberExiGeneratedEventStatus, emberExiEventStatusStructDataIndex),
    EMBER_EXI_SUBSTRUCT(interval, 1, 0, interval, EmberExiGeneratedDateTimeInterval, emberExiDateTimeIntervalStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEventStatus // index 1747
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EventStatus, 0, 0, 65535, 21, 121),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFile // index 1768
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_File, 1, 0, 3463, 36, 122),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFileLink // index 1804
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileLink, 1, 0, 2380, 6, 123),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFileList // index 1810
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileList, 3, 0, 2389, 12, 124),
    EMBER_EXI_SUBSTRUCT_ARRAY(File, 0, 255, File, EmberExiGeneratedFile, emberExiFileStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFileListLink // index 1822
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileListLink, 2, 0, 2404, 6, 125),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFileStatus // index 1828
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileStatus, 1, 0, 3463, 33, 126),
    EMBER_EXI_CH(activateTime, INTEGER, 0, activateTime_option),
    EMBER_EXI_SUBSTRUCT_OPTION(FileLink, 0, 1, FileLink, EmberExiGeneratedFileLink, emberExiFileLinkStructDataIndex),
    EMBER_EXI_CH(loadPercent, UNSIGNED_INTEGER, 255, loadPercent),
    EMBER_EXI_CH(nextRequestAttempt, INTEGER, 255, nextRequestAttempt),
    EMBER_EXI_CH(request503Count, UNSIGNED_INTEGER, 255, request503Count),
    EMBER_EXI_CH(requestFailCount, UNSIGNED_INTEGER, 255, requestFailCount),
    EMBER_EXI_CH(status, UNSIGNED_INTEGER, 255, status),
    EMBER_EXI_CH(statusTime, INTEGER, 255, statusTime),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFileStatusLink // index 1861
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileStatusLink, 1, 0, 2380, 6, 127),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFixedPointType // index 1867
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FixedPointType, 0, 0, 65535, 12, 128),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFixedPowerFactor // index 1879
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FixedPowerFactor, 0, 0, 65535, 15, 129),
    EMBER_EXI_CH(displacement, INTEGER, 255, displacement),
    EMBER_EXI_CH(excitation, INTEGER, 255, excitation),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFixedVAr // index 1894
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FixedVAr, 0, 0, 65535, 12, 130),
    EMBER_EXI_CH(refType, UNSIGNED_INTEGER, 255, refType),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationRequest // index 1906
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationRequest, 4, 7, 67, 21, 132),
    EMBER_EXI_CH(durationRequested, UNSIGNED_INTEGER, 3, durationRequested_option),
    EMBER_EXI_SUBSTRUCT(energyRequested, 1, 0, energyRequested, EmberExiGeneratedRealEnergy, emberExiRealEnergyStructDataIndex),
    EMBER_EXI_SUBSTRUCT(powerRequested, 1, 0, powerRequested, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationRequestList // index 1927
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationRequestList, 4, 0, 3706, 12, 133),
    EMBER_EXI_SUBSTRUCT_ARRAY(FlowReservationRequest, 0, 255, FlowReservationRequest, EmberExiGeneratedFlowReservationRequest, emberExiFlowReservationRequestStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationRequestListLink // index 1939
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationRequestListLink, 2, 0, 2404, 6, 134),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationResponse // index 1945
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationResponse, 4, 7, 67, 24, 135),
    EMBER_EXI_SUBSTRUCT(energyAvailable, 1, 0, energyAvailable, EmberExiGeneratedRealEnergy, emberExiRealEnergyStructDataIndex),
    EMBER_EXI_SUBSTRUCT(powerAvailable, 1, 0, powerAvailable, EmberExiGeneratedActivePower, emberExiActivePowerStructDataIndex),
    EMBER_EXI_CH(reservationStatus, UNSIGNED_INTEGER, 255, reservationStatus),
    EMBER_EXI_CH(subject, BINARY, 255, subject),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationResponseList // index 1969
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationResponseList, 4, 0, 3706, 12, 136),
    EMBER_EXI_SUBSTRUCT_ARRAY(FlowReservationResponse, 0, 255, FlowReservationResponse, EmberExiGeneratedFlowReservationResponse, emberExiFlowReservationResponseStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationResponseListLink // index 1981
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationResponseListLink, 2, 0, 2404, 6, 137),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignments // index 1987
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignments, 0, 10, 2008, 21, 138),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignmentsBase // index 2008
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignmentsBase, 1, 0, 3463, 66, 139),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignmentsList // index 2074
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignmentsList, 4, 0, 3706, 12, 140),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignmentsListLink // index 2086
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignmentsListLink, 2, 0, 2404, 6, 141),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedHistoricalReading // index 2092
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_HistoricalReading, 1, 5, 259, 6, 142),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedHistoricalReadingList // index 2098
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_HistoricalReadingList, 3, 0, 2389, 12, 143),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedHistoricalReadingListLink // index 2110
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_HistoricalReadingListLink, 2, 0, 2404, 6, 144),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIEEE_802_15_4 // index 2116
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IEEE_802_15_4, 0, 0, 65535, 18, 145),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedIPAddr // index 2134
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPAddr, 1, 0, 3463, 15, 146),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedIPAddrList // index 2149
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPAddrList, 3, 0, 2389, 12, 147),
    EMBER_EXI_SUBSTRUCT_ARRAY(IPAddr, 0, 255, IPAddr, EmberExiGeneratedIPAddr, emberExiIPAddrStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIPAddrListLink // index 2161
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPAddrListLink, 2, 0, 2404, 6, 148),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIPInterface // index 2167
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPInterface, 1, 0, 3463, 90, 149),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedIPInterfaceList // index 2257
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPInterfaceList, 3, 0, 2389, 12, 150),
    EMBER_EXI_SUBSTRUCT_ARRAY(IPInterface, 0, 255, IPInterface, EmberExiGeneratedIPInterface, emberExiIPInterfaceStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIPInterfaceListLink // index 2269
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPInterfaceListLink, 2, 0, 2404, 6, 151),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIdentifiedObject // index 2275
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IdentifiedObject, 1, 0, 3463, 15, 152),
    EMBER_EXI_CH(mRID, BINARY, 255, mRID),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_CH(version, UNSIGNED_INTEGER, 0, version_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedInverterStatusType // index 2290
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_InverterStatusType, 0, 0, 65535, 12, 153),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLLInterface // index 2302
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LLInterface, 1, 0, 3463, 60, 155),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedLLInterfaceList // index 2362
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LLInterfaceList, 3, 0, 2389, 12, 156),
    EMBER_EXI_SUBSTRUCT_ARRAY(LLInterface, 0, 255, LLInterface, EmberExiGeneratedLLInterface, emberExiLLInterfaceStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLLInterfaceListLink // index 2374
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LLInterfaceListLink, 2, 0, 2404, 6, 157),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLink // index 2380
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Link, 0, 0, 65535, 9, 158),
    EMBER_EXI_AT_STRING(href, STRING, 255, href),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedList // index 2389
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_List, 0, 0, 3463, 15, 159),
    EMBER_EXI_AT(all, UNSIGNED_INTEGER, 255, all),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(results, UNSIGNED_INTEGER, 255, results),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedListLink // index 2404
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ListLink, 0, 0, 2380, 12, 160),
    EMBER_EXI_AT(all, UNSIGNED_INTEGER, 255, all),
    EMBER_EXI_AT_STRING(href, STRING, 255, href),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLoadShedAvailability // index 2416
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LoadShedAvailability, 1, 0, 3463, 24, 161),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedLoadShedAvailabilityLink // index 2440
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LoadShedAvailabilityLink, 1, 0, 2380, 6, 162),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLocalControlModeStatusType // index 2446
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LocalControlModeStatusType, 0, 0, 65535, 12, 163),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLogEvent // index 2458
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LogEvent, 1, 0, 3463, 27, 165),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedLogEventList // index 2485
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LogEventList, 4, 0, 3706, 12, 166),
    EMBER_EXI_SUBSTRUCT_ARRAY(LogEvent, 0, 255, LogEvent, EmberExiGeneratedLogEvent, emberExiLogEventStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLogEventListLink // index 2497
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LogEventListLink, 2, 0, 2404, 6, 167),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedManufacturerStatusType // index 2503
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ManufacturerStatusType, 0, 0, 65535, 12, 168),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH_STRING(value, STRING, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgram // index 2515
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgram, 2, 3, 3691, 24, 169),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgramList // index 2539
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgramList, 4, 0, 3706, 12, 170),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgramListLink // index 2551
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgramListLink, 2, 0, 2404, 6, 171),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReading // index 2557
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReading, 1, 3, 2587, 30, 172),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingBase // index 2587
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingBase, 1, 3, 2275, 6, 173),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingLink // index 2593
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingLink, 1, 0, 2380, 6, 174),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingList // index 2599
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingList, 4, 0, 3706, 12, 175),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingListLink // index 2611
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingListLink, 2, 0, 2404, 6, 176),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorMeterReading // index 2617
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorMeterReading, 1, 3, 2587, 30, 177),
    EMBER_EXI_CH(lastUpdateTime, INTEGER, 1, lastUpdateTime_option),
    EMBER_EXI_SUBSTRUCT_ARRAY(MirrorReadingSet, 0, 255, MirrorReadingSet, EmberExiGeneratedMirrorReadingSet, emberExiMirrorReadingSetStructDataIndex),
    EMBER_EXI_CH(nextUpdateTime, INTEGER, 2, nextUpdateTime_option),
    EMBER_EXI_SUBSTRUCT_OPTION(Reading, 0, 1, Reading, EmberExiGeneratedReading, emberExiReadingStructDataIndex),
    EMBER_EXI_SUBSTRUCT_OPTION(ReadingType, 0, 1, ReadingType, EmberExiGeneratedReadingType, emberExiReadingTypeStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorMeterReadingList // index 2647
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorMeterReadingList, 3, 0, 2389, 12, 178),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorReadingSet // index 2659
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorReadingSet, 1, 4, 3334, 12, 179),
    EMBER_EXI_SUBSTRUCT_ARRAY(Reading, 0, 255, Reading, EmberExiGeneratedReading, emberExiReadingStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorUsagePoint // index 2671
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorUsagePoint, 1, 6, 4099, 15, 180),
    EMBER_EXI_CH(deviceLFDI, BINARY, 255, deviceLFDI),
    EMBER_EXI_SUBSTRUCT_ARRAY(MirrorMeterReading, 0, 255, MirrorMeterReading, EmberExiGeneratedMirrorMeterReading, emberExiMirrorMeterReadingStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorUsagePointList // index 2686
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorUsagePointList, 3, 0, 2389, 12, 181),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorUsagePointListLink // index 2698
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorUsagePointListLink, 2, 0, 2404, 6, 182),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedNeighbor // index 2704
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Neighbor, 1, 0, 3463, 15, 183),
    EMBER_EXI_CH(isChild, BOOLEAN, 255, isChild),
    EMBER_EXI_CH(linkQuality, UNSIGNED_INTEGER, 255, linkQuality),
    EMBER_EXI_CH(shortAddress, UNSIGNED_INTEGER, 255, shortAddress),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedNeighborList // index 2719
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_NeighborList, 3, 0, 2389, 12, 184),
    EMBER_EXI_SUBSTRUCT_ARRAY(Neighbor, 0, 255, Neighbor, EmberExiGeneratedNeighbor, emberExiNeighborStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedNeighborListLink // index 2731
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_NeighborListLink, 2, 0, 2404, 6, 185),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedNotification // index 2737
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Notification, 1, 1, 3760, 21, 186),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedNotificationList // index 2758
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_NotificationList, 3, 0, 2389, 12, 187),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedNotificationListLink // index 2770
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_NotificationListLink, 2, 0, 2404, 6, 188),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedOffset // index 2776
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Offset, 0, 0, 65535, 15, 189),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedOperationalModeStatusType // index 2791
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_OperationalModeStatusType, 0, 0, 65535, 12, 191),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPEVInfo // index 2803
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PEVInfo, 0, 0, 65535, 36, 193),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPowerConfiguration // index 2839
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PowerConfiguration, 0, 0, 65535, 12, 197),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPowerStatus // index 2851
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PowerStatus, 1, 0, 3463, 33, 200),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPowerStatusLink // index 2884
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PowerStatusLink, 1, 0, 2380, 6, 201),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPrepayOperationStatus // index 2890
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepayOperationStatus, 1, 0, 3463, 24, 203),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPrepayOperationStatusLink // index 2914
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepayOperationStatusLink, 1, 0, 2380, 6, 204),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPrepayment // index 2920
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Prepayment, 1, 3, 2275, 75, 205),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPrepaymentLink // index 2995
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepaymentLink, 1, 0, 2380, 6, 206),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPrepaymentList // index 3001
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepaymentList, 4, 0, 3706, 12, 207),
    EMBER_EXI_SUBSTRUCT_ARRAY(Prepayment, 0, 255, Prepayment, EmberExiGeneratedPrepayment, emberExiPrepaymentStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPrepaymentListLink // index 3013
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepaymentListLink, 2, 0, 2404, 6, 208),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPriceResponse // index 3019
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PriceResponse, 1, 4, 3529, 6, 209),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPriceResponseCfg // index 3025
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PriceResponseCfg, 1, 0, 3463, 18, 210),
    EMBER_EXI_CH(consumeThreshold, INTEGER, 255, consumeThreshold),
    EMBER_EXI_CH(maxReductionThreshold, INTEGER, 255, maxReductionThreshold),
    EMBER_EXI_SUBSTRUCT(RateComponentLink, 1, 0, RateComponentLink, EmberExiGeneratedRateComponentLink, emberExiRateComponentLinkStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPriceResponseCfgList // index 3043
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PriceResponseCfgList, 3, 0, 2389, 12, 211),
    EMBER_EXI_SUBSTRUCT_ARRAY(PriceResponseCfg, 0, 255, PriceResponseCfg, EmberExiGeneratedPriceResponseCfg, emberExiPriceResponseCfgStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPriceResponseCfgListLink // index 3055
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PriceResponseCfgListLink, 2, 0, 2404, 6, 212),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedProjectionReading // index 3061
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ProjectionReading, 1, 5, 259, 6, 215),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedProjectionReadingList // index 3067
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ProjectionReadingList, 3, 0, 2389, 12, 216),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedProjectionReadingListLink // index 3079
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ProjectionReadingListLink, 2, 0, 2404, 6, 217),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRPLInstance // index 3085
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLInstance, 1, 0, 3463, 39, 218),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedRPLInstanceList // index 3124
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLInstanceList, 3, 0, 2389, 12, 219),
    EMBER_EXI_SUBSTRUCT_ARRAY(RPLInstance, 0, 255, RPLInstance, EmberExiGeneratedRPLInstance, emberExiRPLInstanceStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRPLInstanceListLink // index 3136
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLInstanceListLink, 2, 0, 2404, 6, 220),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRPLSourceRoutes // index 3142
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLSourceRoutes, 1, 0, 3463, 12, 221),
    EMBER_EXI_CH(DestAddress, BINARY, 255, DestAddress),
    EMBER_EXI_CH(SourceRoute, BINARY, 255, SourceRoute),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRPLSourceRoutesList // index 3154
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLSourceRoutesList, 3, 0, 2389, 12, 222),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedRPLSourceRoutesListLink // index 3166
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RPLSourceRoutesListLink, 2, 0, 2404, 6, 223),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRandomizableEvent // index 3172
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RandomizableEvent, 4, 6, 1726, 12, 224),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedRateComponent // index 3184
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RateComponent, 1, 3, 2275, 39, 225),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedRateComponentLink // index 3223
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RateComponentLink, 1, 0, 2380, 6, 226),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRateComponentList // index 3229
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RateComponentList, 3, 0, 2389, 12, 227),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedRateComponentListLink // index 3241
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RateComponentListLink, 2, 0, 2404, 6, 228),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReactivePower // index 3247
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReactivePower, 0, 0, 65535, 12, 229),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReading // index 3259
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Reading, 0, 5, 3274, 15, 230),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(subscribable, UNSIGNED_INTEGER, 4, subscribable_option),
    EMBER_EXI_CH(localID, BINARY, 5, localID_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingBase // index 3274
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingBase, 1, 0, 3463, 24, 231),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingLink // index 3298
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingLink, 1, 0, 2380, 6, 232),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingList // index 3304
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingList, 4, 0, 3706, 12, 233),
    EMBER_EXI_SUBSTRUCT_ARRAY(Reading, 0, 255, Reading, EmberExiGeneratedReading, emberExiReadingStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingListLink // index 3316
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingListLink, 2, 0, 2404, 6, 234),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSet // index 3322
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSet, 1, 4, 3334, 12, 235),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetBase // index 3334
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetBase, 1, 3, 2275, 12, 236),
    EMBER_EXI_SUBSTRUCT(timePeriod, 1, 0, timePeriod, EmberExiGeneratedDateTimeInterval, emberExiDateTimeIntervalStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetList // index 3346
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetList, 4, 0, 3706, 12, 237),
    EMBER_EXI_SUBSTRUCT_ARRAY(ReadingSet, 0, 255, ReadingSet, EmberExiGeneratedReadingSet, emberExiReadingSetStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetListLink // index 3358
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetListLink, 2, 0, 2404, 6, 238),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingType // index 3364
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingType, 1, 0, 3463, 63, 239),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingTypeLink // index 3427
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingTypeLink, 1, 0, 2380, 6, 240),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRealEnergy // index 3433
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RealEnergy, 0, 0, 65535, 12, 241),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRegistration // index 3445
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Registration, 1, 0, 3463, 12, 242),
    EMBER_EXI_CH(dateTimeRegistered, INTEGER, 255, dateTimeRegistered),
    EMBER_EXI_CH(pIN, INTEGER, 255, pIN),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRegistrationLink // index 3457
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RegistrationLink, 1, 0, 2380, 6, 243),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResource // index 3463
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Resource, 0, 0, 65535, 9, 245),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRespondableIdentifiedObject // index 3472
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RespondableIdentifiedObject, 3, 0, 3487, 15, 246),
    EMBER_EXI_CH(mRID, BINARY, 255, mRID),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_CH(version, UNSIGNED_INTEGER, 1, version_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRespondableResource // index 3487
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RespondableResource, 0, 0, 3463, 15, 247),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT_STRING(replyTo, STRING, 0, replyTo_option),
    EMBER_EXI_AT(responseRequired, BINARY, 0, responseRequired_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRespondableSubscribableIdentifiedObject // index 3502
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RespondableSubscribableIdentifiedObject, 0, 0, 3487, 27, 248),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT_STRING(replyTo, STRING, 0, replyTo_option),
    EMBER_EXI_AT(responseRequired, BINARY, 0, responseRequired_option),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedResponse // index 3529
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Response, 1, 0, 3463, 18, 249),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedResponseList // index 3547
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseList, 3, 0, 2389, 12, 250),
    EMBER_EXI_SUBSTRUCT_ARRAY(Response, 0, 255, Response, EmberExiGeneratedResponse, emberExiResponseStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResponseListLink // index 3559
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseListLink, 2, 0, 2404, 6, 251),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResponseSet // index 3565
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseSet, 1, 3, 2275, 12, 252),
    EMBER_EXI_SUBSTRUCT_OPTION(ResponseListLink, 0, 1, ResponseListLink, EmberExiGeneratedResponseListLink, emberExiResponseListLinkStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResponseSetList // index 3577
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseSetList, 3, 0, 2389, 12, 253),
    EMBER_EXI_SUBSTRUCT_ARRAY(ResponseSet, 0, 255, ResponseSet, EmberExiGeneratedResponseSet, emberExiResponseSetStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResponseSetListLink // index 3589
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseSetListLink, 2, 0, 2404, 6, 254),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSelfDevice // index 3595
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SelfDevice, 2, 11, 1, 6, 257),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSelfDeviceLink // index 3601
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SelfDeviceLink, 1, 0, 2380, 6, 258),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedServiceChange // index 3607
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ServiceChange, 0, 0, 65535, 12, 259),
    EMBER_EXI_CH(newStatus, UNSIGNED_INTEGER, 255, newStatus),
    EMBER_EXI_CH(startTime, INTEGER, 255, startTime),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedServiceSupplier // index 3619
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ServiceSupplier, 1, 3, 2275, 18, 262),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedServiceSupplierLink // index 3637
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ServiceSupplierLink, 1, 0, 2380, 6, 263),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedServiceSupplierList // index 3643
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ServiceSupplierList, 3, 0, 2389, 12, 264),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSetPoint // index 3655
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SetPoint, 0, 0, 65535, 12, 265),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedStateOfChargeStatusType // index 3667
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_StateOfChargeStatusType, 0, 0, 65535, 12, 267),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedStorageModeStatusType // index 3679
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_StorageModeStatusType, 0, 0, 65535, 12, 268),
    EMBER_EXI_CH(dateTime, INTEGER, 255, dateTime),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableIdentifiedObject // index 3691
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableIdentifiedObject, 2, 0, 3724, 15, 269),
    EMBER_EXI_CH(mRID, BINARY, 255, mRID),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_CH(version, UNSIGNED_INTEGER, 1, version_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableList // index 3706
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableList, 0, 0, 3724, 18, 270),
    EMBER_EXI_AT(all, UNSIGNED_INTEGER, 255, all),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(results, UNSIGNED_INTEGER, 255, results),
    EMBER_EXI_AT(subscribable, UNSIGNED_INTEGER, 0, subscribable_option),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableResource // index 3724
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableResource, 0, 0, 3463, 12, 271),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(subscribable, UNSIGNED_INTEGER, 0, subscribable_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscription // index 3736
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Subscription, 1, 1, 3760, 24, 272),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionBase // index 3760
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionBase, 1, 0, 3463, 9, 273),
    EMBER_EXI_CH_STRING(subscribedResource, STRING, 255, subscribedResource),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionList // index 3769
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionList, 3, 0, 2389, 12, 274),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionListLink // index 3781
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionListLink, 2, 0, 2404, 6, 275),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSupplyInterruptionOverride // index 3787
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupplyInterruptionOverride, 1, 0, 3463, 15, 276),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_SUBSTRUCT(interval, 1, 0, interval, EmberExiGeneratedDateTimeInterval, emberExiDateTimeIntervalStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSupplyInterruptionOverrideList // index 3802
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupplyInterruptionOverrideList, 3, 0, 2389, 12, 277),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSupplyInterruptionOverrideListLink // index 3814
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupplyInterruptionOverrideListLink, 2, 0, 2404, 6, 278),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSupportedLocale // index 3820
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupportedLocale, 1, 0, 3463, 9, 279),
    EMBER_EXI_CH_STRING(locale, STRING, 255, locale),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSupportedLocaleList // index 3829
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupportedLocaleList, 3, 0, 2389, 12, 280),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSupportedLocaleListLink // index 3841
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupportedLocaleListLink, 2, 0, 2404, 6, 281),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTargetReading // index 3847
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TargetReading, 1, 5, 259, 6, 283),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTargetReadingList // index 3853
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TargetReadingList, 3, 0, 2389, 12, 284),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTargetReadingListLink // index 3865
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TargetReadingListLink, 2, 0, 2404, 6, 285),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTargetReduction // index 3871
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TargetReduction, 0, 0, 65535, 12, 286),
    EMBER_EXI_CH(type, UNSIGNED_INTEGER, 255, type),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTariffProfile // index 3883
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TariffProfile, 1, 3, 2275, 27, 287),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTariffProfileLink // index 3910
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TariffProfileLink, 1, 0, 2380, 6, 288),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTariffProfileList // index 3916
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TariffProfileList, 4, 0, 3706, 12, 289),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTariffProfileListLink // index 3928
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TariffProfileListLink, 2, 0, 2404, 6, 290),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTemperature // index 3934
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Temperature, 0, 0, 65535, 15, 291),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(subject, UNSIGNED_INTEGER, 255, subject),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessage // index 3949
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessage, 4, 6, 1726, 15, 292),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessageList // index 3964
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessageList, 4, 0, 3706, 12, 293),
    EMBER_EXI_SUBSTRUCT_ARRAY(TextMessage, 0, 255, TextMessage, EmberExiGeneratedTextMessage, emberExiTextMessageStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessageListLink // index 3976
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessageListLink, 2, 0, 2404, 6, 294),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextResponse // index 3982
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextResponse, 1, 4, 3529, 6, 295),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTime // index 3988
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Time, 1, 0, 3463, 27, 296),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeConfiguration // index 4015
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeConfiguration, 0, 0, 65535, 18, 297),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeLink // index 4033
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeLink, 1, 0, 2380, 6, 298),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTimeTariffInterval // index 4039
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeTariffInterval, 4, 8, 3172, 15, 300),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeTariffIntervalList // index 4054
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeTariffIntervalList, 4, 0, 3706, 12, 301),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeTariffIntervalListLink // index 4066
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeTariffIntervalListLink, 2, 0, 2404, 6, 302),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUnitValueType // index 4072
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UnitValueType, 0, 0, 65535, 15, 305),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(unit, UNSIGNED_INTEGER, 255, unit),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePoint // index 4087
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePoint, 1, 6, 4099, 12, 307),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointBase // index 4099
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointBase, 1, 3, 2275, 15, 308),
    EMBER_EXI_CH(roleFlags, BINARY, 255, roleFlags),
    EMBER_EXI_CH(serviceCategoryKind, UNSIGNED_INTEGER, 255, serviceCategoryKind),
    EMBER_EXI_CH(status, UNSIGNED_INTEGER, 255, status),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointLink // index 4114
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointLink, 1, 0, 2380, 6, 309),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointList // index 4120
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointList, 4, 0, 3706, 12, 310),
    EMBER_EXI_SUBSTRUCT_ARRAY(UsagePoint, 0, 255, UsagePoint, EmberExiGeneratedUsagePoint, emberExiUsagePointStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointListLink // index 4132
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointListLink, 2, 0, 2404, 6, 311),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedVoltageRMS // index 4138
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_VoltageRMS, 0, 0, 65535, 12, 313),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedWattHour // index 4150
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_WattHour, 0, 0, 65535, 12, 314),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedloWPAN // index 4162
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_loWPAN, 0, 0, 65535, 21, 315),
...
void emberExiPrintStructAbstractFlowReservation(EmberExiGeneratedAbstractFlowReservation *data)
{
  emExiPrintStruct(emberExiAbstractFlowReservationStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructAbstractFlowReservation(EmberExiGeneratedAbstractFlowReservation *data) {
  EXI_DEBUG1("Start to XML: AbstractFlowReservation\n");
  emberExiPrintfLine("<AbstractFlowReservation");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  ...
  emberExiPrintfLine("</AbstractFlowReservation>");
  EXI_DEBUG1("End to XML: AbstractFlowReservation\n");
}
...
void emberExiPrintStructActiveFlowReservationListLink(EmberExiGeneratedActiveFlowReservationListLink *data)
{
  emExiPrintStruct(emberExiActiveFlowReservationListLinkStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructActiveFlowReservationListLink(EmberExiGeneratedActiveFlowReservationListLink *data) {
  EXI_DEBUG1("Start to XML: ActiveFlowReservationListLink\n");
  emberExiPrintfLine("<ActiveFlowReservationListLink");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href);
  emberExiPrintfLine(">");
  emberExiPrintfLine("</ActiveFlowReservationListLink>");
  EXI_DEBUG1("End to XML: ActiveFlowReservationListLink\n");
}
...
void emberExiPrintStructApparentPower(EmberExiGeneratedApparentPower *data)
{
  emExiPrintStruct(emberExiApparentPowerStructData,
                   (int8u *) data,
                   0,
                   "ApparentPower",
                   emberExiQnames);
...
void emberExiToXmlStructApparentPower(EmberExiGeneratedApparentPower *data) {
  EXI_DEBUG1("Start to XML: ApparentPower\n");
  emberExiPrintfLine("<ApparentPower");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</ApparentPower>");
  EXI_DEBUG1("End to XML: ApparentPower\n");
}
...
void emberExiPrintStructConnectStatusType(EmberExiGeneratedConnectStatusType *data)
{
  emExiPrintStruct(emberExiConnectStatusTypeStructData,
                   (int8u *) data,
                   0,
                   "ConnectStatusType",
                   emberExiQnames);
...
void emberExiToXmlStructConnectStatusType(EmberExiGeneratedConnectStatusType *data) {
  EXI_DEBUG1("Start to XML: ConnectStatusType\n");
  emberExiPrintfLine("<ConnectStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</ConnectStatusType>");
  EXI_DEBUG1("End to XML: ConnectStatusType\n");
}
...
void emberExiPrintStructCurrentRMS(EmberExiGeneratedCurrentRMS *data)
{
  emExiPrintStruct(emberExiCurrentRMSStructData,
                   (int8u *) data,
                   0,
                   "CurrentRMS",
                   emberExiQnames);
...
void emberExiToXmlStructCurrentRMS(EmberExiGeneratedCurrentRMS *data) {
  EXI_DEBUG1("Start to XML: CurrentRMS\n");
  emberExiPrintfLine("<CurrentRMS");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</CurrentRMS>");
  EXI_DEBUG1("End to XML: CurrentRMS\n");
}
...
void emberExiPrintStructDERAvailability(EmberExiGeneratedDERAvailability *data)
{
  emExiPrintStruct(emberExiDERAvailabilityStructData,
                   (int8u *) data,
                   0,
                   "DERAvailability",
                   emberExiQnames);
...
void emberExiToXmlStructDERAvailability(EmberExiGeneratedDERAvailability *data) {
  EXI_DEBUG1("Start to XML: DERAvailability\n");
  emberExiPrintfLine("<DERAvailability");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <availabilityDuration>%d</availabilityDuration>", data->availabilityDuration_option);
  emberExiPrintfLine("  <maxChargeDuration>%d</maxChargeDuration>", data->maxChargeDuration_option);
  emberExiPrintfLine("  <readingTime>%d</readingTime>", data->readingTime);
  emberExiPrintfLine("  <reserveChargePercent>%d</reserveChargePercent>", data->reserveChargePercent_option);
  emberExiPrintfLine("  <reservePercent>%d</reservePercent>", data->reservePercent_option);
    if ( data->statVArAvail_option != NULL )
      emberExiToXmlStructReactivePower((data->statVArAvail_option));
    if ( data->statWAvail_option != NULL )
      emberExiToXmlStructActivePower((data->statWAvail_option));
  emberExiPrintfLine("</DERAvailability>");
  EXI_DEBUG1("End to XML: DERAvailability\n");
}
...
void emberExiPrintStructDERCapability(EmberExiGeneratedDERCapability *data)
{
  emExiPrintStruct(emberExiDERCapabilityStructData,
                   (int8u *) data,
                   0,
                   "DERCapability",
                   emberExiQnames);
...
void emberExiToXmlStructDERCapability(EmberExiGeneratedDERCapability *data) {
  EXI_DEBUG1("Start to XML: DERCapability\n");
  emberExiPrintfLine("<DERCapability");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <modesSupported>");
  { int16u i;
    for ( i=0; i<data->modesSupported.length; i++ )
      emberExiPrintfLine("%2x", data->modesSupported.bytes[i]);
  }
  emberExiPrintfLine("</modesSupported>");
    if ( data->rtgA != NULL )
      emberExiToXmlStructCurrentRMS((data->rtgA));
    if ( data->rtgAh_option != NULL )
      emberExiToXmlStructAmpereHour((data->rtgAh_option));
    if ( data->rtgMaxChargeRate_option != NULL )
      emberExiToXmlStructActivePower((data->rtgMaxChargeRate_option));
    if ( data->rtgMaxDischargeRate_option != NULL )
      emberExiToXmlStructActivePower((data->rtgMaxDischargeRate_option));
    if ( data->rtgMinPF_option != NULL )
      emberExiToXmlStructFixedPointType((data->rtgMinPF_option));
    if ( data->rtgMinPFUnder_option != NULL )
      emberExiToXmlStructFixedPointType((data->rtgMinPFUnder_option));
    if ( data->rtgVA_option != NULL )
      emberExiToXmlStructApparentPower((data->rtgVA_option));
    if ( data->rtgVAr_option != NULL )
      emberExiToXmlStructReactivePower((data->rtgVAr_option));
    if ( data->rtgVArNeg_option != NULL )
      emberExiToXmlStructReactivePower((data->rtgVArNeg_option));
    if ( data->rtgW != NULL )
      emberExiToXmlStructActivePower((data->rtgW));
    if ( data->rtgWh_option != NULL )
      emberExiToXmlStructWattHour((data->rtgWh_option));
  emberExiPrintfLine("  <type>%d</type>", data->type);
  emberExiPrintfLine("</DERCapability>");
  EXI_DEBUG1("End to XML: DERCapability\n");
}
...
void emberExiPrintStructDERProgramLink(EmberExiGeneratedDERProgramLink *data)
{
  emExiPrintStruct(emberExiDERProgramLinkStructData,
                   (int8u *) data,
                   0,
                   "DERProgramLink",
                   emberExiQnames);
...
void emberExiToXmlStructDERProgramLink(EmberExiGeneratedDERProgramLink *data) {
  EXI_DEBUG1("Start to XML: DERProgramLink\n");
  emberExiPrintfLine("<DERProgramLink");
  emberExiPrintfLine("  href=\"%s\"", data->href);
  emberExiPrintfLine(">");
  emberExiPrintfLine("</DERProgramLink>");
  EXI_DEBUG1("End to XML: DERProgramLink\n");
}
...
void emberExiPrintStructDERSettings(EmberExiGeneratedDERSettings *data)
{
  emExiPrintStruct(emberExiDERSettingsStructData,
                   (int8u *) data,
                   0,
                   "DERSettings",
                   emberExiQnames);
...
void emberExiToXmlStructDERSettings(EmberExiGeneratedDERSettings *data) {
  EXI_DEBUG1("Start to XML: DERSettings\n");
  emberExiPrintfLine("<DERSettings");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <setGenConnect>%d</setGenConnect>", data->setGenConnect_option);
  emberExiPrintfLine("  <setGradW>%d</setGradW>", data->setGradW);
    if ( data->setMaxChargeRate_option != NULL )
      emberExiToXmlStructActivePower((data->setMaxChargeRate_option));
    if ( data->setMaxDischargeRate_option != NULL )
      emberExiToXmlStructActivePower((data->setMaxDischargeRate_option));
    if ( data->setMaxVA_option != NULL )
      emberExiToXmlStructApparentPower((data->setMaxVA_option));
    if ( data->setMaxVAr_option != NULL )
      emberExiToXmlStructReactivePower((data->setMaxVAr_option));
    if ( data->setMaxVArNeg_option != NULL )
      emberExiToXmlStructReactivePower((data->setMaxVArNeg_option));
    if ( data->setMaxW != NULL )
      emberExiToXmlStructActivePower((data->setMaxW));
    if ( data->setMinPF_option != NULL )
      emberExiToXmlStructFixedPointType((data->setMinPF_option));
    if ( data->setMinPFUnder_option != NULL )
      emberExiToXmlStructFixedPointType((data->setMinPFUnder_option));
  emberExiPrintfLine("  <setStorConnect>%d</setStorConnect>", data->setStorConnect_option);
    if ( data->setVRef_option != NULL )
      emberExiToXmlStructVoltageRMS((data->setVRef_option));
    if ( data->setVRefOfs_option != NULL )
      emberExiToXmlStructVoltageRMS((data->setVRefOfs_option));
  emberExiPrintfLine("  <updatedTime>%d</updatedTime>", data->updatedTime);
  emberExiPrintfLine("</DERSettings>");
  EXI_DEBUG1("End to XML: DERSettings\n");
}
...
void emberExiToXmlStructDERStatus(EmberExiGeneratedDERStatus *data) {
  ...
  emberExiPrintfLine(">");
    if ( data->genConnectStatus_option != NULL )
      emberExiToXmlStructConnectStatusType((data->genConnectStatus_option));
    if ( data->inverterStatus_option != NULL )
      emberExiToXmlStructInverterStatusType((data->inverterStatus_option));
    if ( data->localControlModeStatus_option != NULL )
      emberExiToXmlStructLocalControlModeStatusType((data->localControlModeStatus_option));
    if ( data->manufacturerStatus_option != NULL )
      emberExiToXmlStructManufacturerStatusType((data->manufacturerStatus_option));
    if ( data->operationalModeStatus_option != NULL )
      emberExiToXmlStructOperationalModeStatusType((data->operationalModeStatus_option));
  emberExiPrintfLine("  <readingTime>%d</readingTime>", data->readingTime);
    if ( data->stateOfChargeStatus_option != NULL )
      emberExiToXmlStructStateOfChargeStatusType((data->stateOfChargeStatus_option));
    if ( data->storageModeStatus_option != NULL )
      emberExiToXmlStructStorageModeStatusType((data->storageModeStatus_option));
    if ( data->storConnectStatus_option != NULL )
      emberExiToXmlStructConnectStatusType((data->storConnectStatus_option));
  emberExiPrintfLine("</DERStatus>");
...
void emberExiPrintStructDefaultDERControl(EmberExiGeneratedDefaultDERControl *data)
{
  emExiPrintStruct(emberExiDefaultDERControlStructData,
                   (int8u *) data,
                   0,
                   "DefaultDERControl",
                   emberExiQnames);
...
void emberExiToXmlStructDefaultDERControl(EmberExiGeneratedDefaultDERControl *data) {
  EXI_DEBUG1("Start to XML: DefaultDERControl\n");
  emberExiPrintfLine("<DefaultDERControl");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <mRID>");
  ...
  emberExiPrintfLine("  <version>%d</version>", data->version_option);
    if ( data->DERControlBase != NULL )
      emberExiToXmlStructDERControlBase((data->DERControlBase));
  emberExiPrintfLine("</DefaultDERControl>");
  EXI_DEBUG1("End to XML: DefaultDERControl\n");
}
...
void emberExiPrintStructError(EmberExiGeneratedError *data)
{
  emExiPrintStruct(emberExiErrorStructData,
                   (int8u *) data,
                   0,
                   "Error",
                   emberExiQnames);
...
void emberExiToXmlStructError(EmberExiGeneratedError *data) {
  EXI_DEBUG1("Start to XML: Error\n");
  emberExiPrintfLine("<Error");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <maxRetryDuration>%d</maxRetryDuration>", data->maxRetryDuration_option);
  emberExiPrintfLine("  <reasonCode>%d</reasonCode>", data->reasonCode);
  emberExiPrintfLine("</Error>");
  EXI_DEBUG1("End to XML: Error\n");
}
...
void emberExiPrintStructFileLink(EmberExiGeneratedFileLink *data)
{
  emExiPrintStruct(emberExiFileLinkStructData,
                   (int8u *) data,
                   0,
                   "FileLink",
                   emberExiQnames);
...
void emberExiToXmlStructFileLink(EmberExiGeneratedFileLink *data) {
  EXI_DEBUG1("Start to XML: FileLink\n");
  emberExiPrintfLine("<FileLink");
  emberExiPrintfLine("  href=\"%s\"", data->href);
  emberExiPrintfLine(">");
  emberExiPrintfLine("</FileLink>");
  EXI_DEBUG1("End to XML: FileLink\n");
}
...
void emberExiToXmlStructFileStatus(EmberExiGeneratedFileStatus *data) {
  ...
  emberExiPrintfLine("  <activateTime>%d</activateTime>", data->activateTime_option);
    if ( data->FileLink_option != NULL )
      emberExiToXmlStructFileLink((data->FileLink_option));
  emberExiPrintfLine("  <loadPercent>%d</loadPercent>", data->loadPercent);
  emberExiPrintfLine("  <nextRequestAttempt>%d</nextRequestAttempt>", data->nextRequestAttempt);
  emberExiPrintfLine("  <request503Count>%d</request503Count>", data->request503Count);
  emberExiPrintfLine("  <requestFailCount>%d</requestFailCount>", data->requestFailCount);
...
void emberExiPrintStructFixedPointType(EmberExiGeneratedFixedPointType *data)
{
  emExiPrintStruct(emberExiFixedPointTypeStructData,
                   (int8u *) data,
                   0,
                   "FixedPointType",
                   emberExiQnames);
...
void emberExiToXmlStructFixedPointType(EmberExiGeneratedFixedPointType *data) {
  EXI_DEBUG1("Start to XML: FixedPointType\n");
  emberExiPrintfLine("<FixedPointType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</FixedPointType>");
  EXI_DEBUG1("End to XML: FixedPointType\n");
}
...
void emberExiPrintStructFlowReservationRequest(EmberExiGeneratedFlowReservationRequest *data)
{
  emExiPrintStruct(emberExiFlowReservationRequestStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructFlowReservationRequest(EmberExiGeneratedFlowReservationRequest *data) {
  EXI_DEBUG1("Start to XML: FlowReservationRequest\n");
  emberExiPrintfLine("<FlowReservationRequest");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  replyTo=\"%s\"", data->replyTo_option);
  emberExiPrintfLine("responseRequired=\"");
  { int16u i;
  ...
  emberExiPrintfLine("  <creationTime>%d</creationTime>", data->creationTime);
    ...
    if ( data->UsagePointLink_option != NULL )
      emberExiToXmlStructUsagePointLink((data->UsagePointLink_option));
  emberExiPrintfLine("  <durationRequested>%d</durationRequested>", data->durationRequested_option);
    if ( data->energyRequested != NULL )
      emberExiToXmlStructRealEnergy((data->energyRequested));
    if ( data->powerRequested != NULL )
      emberExiToXmlStructActivePower((data->powerRequested));
  emberExiPrintfLine("</FlowReservationRequest>");
  EXI_DEBUG1("End to XML: FlowReservationRequest\n");
}




void emberExiPrintStructFlowReservationRequestList(EmberExiGeneratedFlowReservationRequestList *data)
{
  emExiPrintStruct(emberExiFlowReservationRequestListStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructFlowReservationRequestList(EmberExiGeneratedFlowReservationRequestList *data) {
  EXI_DEBUG1("Start to XML: FlowReservationRequestList\n");
  emberExiPrintfLine("<FlowReservationRequestList");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  results=\"%d\"", data->results);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  ...
  { int16u i;
    ...
    if ( data->FlowReservationRequest_array != NULL )
      emberExiToXmlStructFlowReservationRequest(&(data->FlowReservationRequest_array[i]));
  }
  emberExiPrintfLine("</FlowReservationRequestList>");
  EXI_DEBUG1("End to XML: FlowReservationRequestList\n");
}
...
void emberExiPrintStructFlowReservationResponse(EmberExiGeneratedFlowReservationResponse *data)
{
  emExiPrintStruct(emberExiFlowReservationResponseStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructFlowReservationResponse(EmberExiGeneratedFlowReservationResponse *data) {
  EXI_DEBUG1("Start to XML: FlowReservationResponse\n");
  emberExiPrintfLine("<FlowReservationResponse");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  replyTo=\"%s\"", data->replyTo_option);
  emberExiPrintfLine("responseRequired=\"");
  { int16u i;
  ...
  emberExiPrintfLine("  <creationTime>%d</creationTime>", data->creationTime);
    ...
    if ( data->energyAvailable != NULL )
      emberExiToXmlStructRealEnergy((data->energyAvailable));
    if ( data->powerAvailable != NULL )
      emberExiToXmlStructActivePower((data->powerAvailable));
  emberExiPrintfLine("  <reservationStatus>%d</reservationStatus>", data->reservationStatus);
  emberExiPrintfLine("  <subject>");
  { int16u i;
    for ( i=0; i<data->subject.length; i++ )
      emberExiPrintfLine("%2x", data->subject.bytes[i]);
  ...
  emberExiPrintfLine("</subject>");
  emberExiPrintfLine("</FlowReservationResponse>");
  EXI_DEBUG1("End to XML: FlowReservationResponse\n");
}




void emberExiPrintStructFlowReservationResponseList(EmberExiGeneratedFlowReservationResponseList *data)
{
  emExiPrintStruct(emberExiFlowReservationResponseListStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructFlowReservationResponseList(EmberExiGeneratedFlowReservationResponseList *data) {
  EXI_DEBUG1("Start to XML: FlowReservationResponseList\n");
  emberExiPrintfLine("<FlowReservationResponseList");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  results=\"%d\"", data->results);
  emberExiPrintfLine("  subscribable=\"%d\"", data->subscribable_option);
  ...
  { int16u i;
    ...
    if ( data->FlowReservationResponse_array != NULL )
      emberExiToXmlStructFlowReservationResponse(&(data->FlowReservationResponse_array[i]));
  }
  emberExiPrintfLine("</FlowReservationResponseList>");
  EXI_DEBUG1("End to XML: FlowReservationResponseList\n");
}
...
void emberExiPrintStructInverterStatusType(EmberExiGeneratedInverterStatusType *data)
{
  emExiPrintStruct(emberExiInverterStatusTypeStructData,
                   (int8u *) data,
                   0,
                   "InverterStatusType",
                   emberExiQnames);
...
void emberExiToXmlStructInverterStatusType(EmberExiGeneratedInverterStatusType *data) {
  EXI_DEBUG1("Start to XML: InverterStatusType\n");
  emberExiPrintfLine("<InverterStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</InverterStatusType>");
  EXI_DEBUG1("End to XML: InverterStatusType\n");
}
...
void emberExiPrintStructLocalControlModeStatusType(EmberExiGeneratedLocalControlModeStatusType *data)
{
  emExiPrintStruct(emberExiLocalControlModeStatusTypeStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructLocalControlModeStatusType(EmberExiGeneratedLocalControlModeStatusType *data) {
  EXI_DEBUG1("Start to XML: LocalControlModeStatusType\n");
  emberExiPrintfLine("<LocalControlModeStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</LocalControlModeStatusType>");
  EXI_DEBUG1("End to XML: LocalControlModeStatusType\n");
}
...
void emberExiPrintStructManufacturerStatusType(EmberExiGeneratedManufacturerStatusType *data)
{
  emExiPrintStruct(emberExiManufacturerStatusTypeStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructManufacturerStatusType(EmberExiGeneratedManufacturerStatusType *data) {
  EXI_DEBUG1("Start to XML: ManufacturerStatusType\n");
  emberExiPrintfLine("<ManufacturerStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%s</value>", data->value);
  emberExiPrintfLine("</ManufacturerStatusType>");
  EXI_DEBUG1("End to XML: ManufacturerStatusType\n");
}
...
void emberExiToXmlStructMirrorMeterReading(EmberExiGeneratedMirrorMeterReading *data) {
  ...
  { int16u i;
    ...
    if ( data->MirrorReadingSet_array != NULL )
      emberExiToXmlStructMirrorReadingSet(&(data->MirrorReadingSet_array[i]));
  }
  emberExiPrintfLine("  <nextUpdateTime>%d</nextUpdateTime>", data->nextUpdateTime_option);
    if ( data->Reading_option != NULL )
      emberExiToXmlStructReading((data->Reading_option));
    if ( data->ReadingType_option != NULL )
      emberExiToXmlStructReadingType((data->ReadingType_option));
  emberExiPrintfLine("</MirrorMeterReading>");
...
void emberExiPrintStructMirrorMeterReadingList(EmberExiGeneratedMirrorMeterReadingList *data)
{
  emExiPrintStruct(emberExiMirrorMeterReadingListStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructMirrorMeterReadingList(EmberExiGeneratedMirrorMeterReadingList *data) {
  EXI_DEBUG1("Start to XML: MirrorMeterReadingList\n");
  emberExiPrintfLine("<MirrorMeterReadingList");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  results=\"%d\"", data->results);
  emberExiPrintfLine(">");
  ...
  emberExiPrintfLine("</MirrorMeterReadingList>");
  EXI_DEBUG1("End to XML: MirrorMeterReadingList\n");
}




void emberExiPrintStructMirrorReadingSet(EmberExiGeneratedMirrorReadingSet *data)
{
  emExiPrintStruct(emberExiMirrorReadingSetStructData,
                   (int8u *) data,
                   0,
                   "MirrorReadingSet",
                   emberExiQnames);
...
void emberExiToXmlStructMirrorReadingSet(EmberExiGeneratedMirrorReadingSet *data) {
  EXI_DEBUG1("Start to XML: MirrorReadingSet\n");
  emberExiPrintfLine("<MirrorReadingSet");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <mRID>");
  { int16u i;
  ...
  emberExiPrintfLine("</MirrorReadingSet>");
  EXI_DEBUG1("End to XML: MirrorReadingSet\n");
}
...
void emberExiToXmlStructMirrorUsagePoint(EmberExiGeneratedMirrorUsagePoint *data) {
  ...
  emberExiPrintfLine("  <status>%d</status>", data->status);
  emberExiPrintfLine("  <deviceLFDI>");
  { int16u i;
    for ( i=0; i<data->deviceLFDI.length; i++ )
      emberExiPrintfLine("%2x", data->deviceLFDI.bytes[i]);
  }
  emberExiPrintfLine("</deviceLFDI>");
  { int16u i;
    for ( i=0; i<data->MirrorMeterReading_count; i++ )
...
void emberExiPrintStructOperationalModeStatusType(EmberExiGeneratedOperationalModeStatusType *data)
{
  emExiPrintStruct(emberExiOperationalModeStatusTypeStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructOperationalModeStatusType(EmberExiGeneratedOperationalModeStatusType *data) {
  EXI_DEBUG1("Start to XML: OperationalModeStatusType\n");
  emberExiPrintfLine("<OperationalModeStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</OperationalModeStatusType>");
  EXI_DEBUG1("End to XML: OperationalModeStatusType\n");
}
...
void emberExiPrintStructPriceResponseCfg(EmberExiGeneratedPriceResponseCfg *data)
{
  emExiPrintStruct(emberExiPriceResponseCfgStructData,
                   (int8u *) data,
                   0,
                   "PriceResponseCfg",
                   emberExiQnames);
...
void emberExiToXmlStructPriceResponseCfg(EmberExiGeneratedPriceResponseCfg *data) {
  EXI_DEBUG1("Start to XML: PriceResponseCfg\n");
  emberExiPrintfLine("<PriceResponseCfg");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <consumeThreshold>%d</consumeThreshold>", data->consumeThreshold);
  emberExiPrintfLine("  <maxReductionThreshold>%d</maxReductionThreshold>", data->maxReductionThreshold);
    if ( data->RateComponentLink != NULL )
      emberExiToXmlStructRateComponentLink((data->RateComponentLink));
  emberExiPrintfLine("</PriceResponseCfg>");
  EXI_DEBUG1("End to XML: PriceResponseCfg\n");
}




void emberExiPrintStructPriceResponseCfgList(EmberExiGeneratedPriceResponseCfgList *data)
{
  emExiPrintStruct(emberExiPriceResponseCfgListStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructPriceResponseCfgList(EmberExiGeneratedPriceResponseCfgList *data) {
  EXI_DEBUG1("Start to XML: PriceResponseCfgList\n");
  emberExiPrintfLine("<PriceResponseCfgList");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  results=\"%d\"", data->results);
  emberExiPrintfLine(">");
  { int16u i;
    ...
    if ( data->PriceResponseCfg_array != NULL )
      emberExiToXmlStructPriceResponseCfg(&(data->PriceResponseCfg_array[i]));
  }
  emberExiPrintfLine("</PriceResponseCfgList>");
  EXI_DEBUG1("End to XML: PriceResponseCfgList\n");
}
...
void emberExiPrintStructRateComponentLink(EmberExiGeneratedRateComponentLink *data)
{
  emExiPrintStruct(emberExiRateComponentLinkStructData,
                   (int8u *) data,
                   0,
                   "RateComponentLink",
                   emberExiQnames);
...
void emberExiToXmlStructRateComponentLink(EmberExiGeneratedRateComponentLink *data) {
  EXI_DEBUG1("Start to XML: RateComponentLink\n");
  emberExiPrintfLine("<RateComponentLink");
  emberExiPrintfLine("  href=\"%s\"", data->href);
  emberExiPrintfLine(">");
  emberExiPrintfLine("</RateComponentLink>");
  EXI_DEBUG1("End to XML: RateComponentLink\n");
}
...
void emberExiPrintStructReactivePower(EmberExiGeneratedReactivePower *data)
{
  emExiPrintStruct(emberExiReactivePowerStructData,
                   (int8u *) data,
                   0,
                   "ReactivePower",
                   emberExiQnames);
...
void emberExiToXmlStructReactivePower(EmberExiGeneratedReactivePower *data) {
  EXI_DEBUG1("Start to XML: ReactivePower\n");
  emberExiPrintfLine("<ReactivePower");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</ReactivePower>");
  EXI_DEBUG1("End to XML: ReactivePower\n");
}
...
void emberExiToXmlStructRegistration(EmberExiGeneratedRegistration *data) {
  ...
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTimeRegistered>%d</dateTimeRegistered>", data->dateTimeRegistered);
  emberExiPrintfLine("  <pIN>%d</pIN>", data->pIN);
  emberExiPrintfLine("</Registration>");
...
void emberExiPrintStructRespondableIdentifiedObject(EmberExiGeneratedRespondableIdentifiedObject *data)
{
  emExiPrintStruct(emberExiRespondableIdentifiedObjectStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructRespondableIdentifiedObject(EmberExiGeneratedRespondableIdentifiedObject *data) {
  EXI_DEBUG1("Start to XML: RespondableIdentifiedObject\n");
  emberExiPrintfLine("<RespondableIdentifiedObject");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  replyTo=\"%s\"", data->replyTo_option);
  emberExiPrintfLine("responseRequired=\"");
  { int16u i;
  ...
  emberExiPrintfLine("  <version>%d</version>", data->version_option);
  emberExiPrintfLine("</RespondableIdentifiedObject>");
  EXI_DEBUG1("End to XML: RespondableIdentifiedObject\n");
}
...
void emberExiPrintStructResponseSet(EmberExiGeneratedResponseSet *data)
{
  emExiPrintStruct(emberExiResponseSetStructData,
                   (int8u *) data,
                   0,
                   "ResponseSet",
                   emberExiQnames);
...
void emberExiToXmlStructResponseSet(EmberExiGeneratedResponseSet *data) {
  EXI_DEBUG1("Start to XML: ResponseSet\n");
  emberExiPrintfLine("<ResponseSet");
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <mRID>");
  { int16u i;
  ...
  emberExiPrintfLine("  <version>%d</version>", data->version_option);
    if ( data->ResponseListLink_option != NULL )
      emberExiToXmlStructResponseListLink((data->ResponseListLink_option));
  emberExiPrintfLine("</ResponseSet>");
  EXI_DEBUG1("End to XML: ResponseSet\n");
}




void emberExiPrintStructResponseSetList(EmberExiGeneratedResponseSetList *data)
{
  emExiPrintStruct(emberExiResponseSetListStructData,
                   (int8u *) data,
                   0,
                   "ResponseSetList",
                   emberExiQnames);
...
void emberExiToXmlStructResponseSetList(EmberExiGeneratedResponseSetList *data) {
  EXI_DEBUG1("Start to XML: ResponseSetList\n");
  emberExiPrintfLine("<ResponseSetList");
  emberExiPrintfLine("  all=\"%d\"", data->all);
  emberExiPrintfLine("  href=\"%s\"", data->href_option);
  emberExiPrintfLine("  results=\"%d\"", data->results);
  emberExiPrintfLine(">");
  { int16u i;
    ...
    if ( data->ResponseSet_array != NULL )
      emberExiToXmlStructResponseSet(&(data->ResponseSet_array[i]));
  }
  emberExiPrintfLine("</ResponseSetList>");
  EXI_DEBUG1("End to XML: ResponseSetList\n");
}
...
void emberExiPrintStructStateOfChargeStatusType(EmberExiGeneratedStateOfChargeStatusType *data)
{
  emExiPrintStruct(emberExiStateOfChargeStatusTypeStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructStateOfChargeStatusType(EmberExiGeneratedStateOfChargeStatusType *data) {
  EXI_DEBUG1("Start to XML: StateOfChargeStatusType\n");
  emberExiPrintfLine("<StateOfChargeStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</StateOfChargeStatusType>");
  EXI_DEBUG1("End to XML: StateOfChargeStatusType\n");
}




void emberExiPrintStructStorageModeStatusType(EmberExiGeneratedStorageModeStatusType *data)
{
  emExiPrintStruct(emberExiStorageModeStatusTypeStructData,
                   (int8u *) data,
                   0,
...
void emberExiToXmlStructStorageModeStatusType(EmberExiGeneratedStorageModeStatusType *data) {
  EXI_DEBUG1("Start to XML: StorageModeStatusType\n");
  emberExiPrintfLine("<StorageModeStatusType");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <dateTime>%d</dateTime>", data->dateTime);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</StorageModeStatusType>");
  EXI_DEBUG1("End to XML: StorageModeStatusType\n");
}
...
void emberExiPrintStructVoltageRMS(EmberExiGeneratedVoltageRMS *data)
{
  emExiPrintStruct(emberExiVoltageRMSStructData,
                   (int8u *) data,
                   0,
                   "VoltageRMS",
                   emberExiQnames);
...
void emberExiToXmlStructVoltageRMS(EmberExiGeneratedVoltageRMS *data) {
  EXI_DEBUG1("Start to XML: VoltageRMS\n");
  emberExiPrintfLine("<VoltageRMS");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</VoltageRMS>");
  EXI_DEBUG1("End to XML: VoltageRMS\n");
}




void emberExiPrintStructWattHour(EmberExiGeneratedWattHour *data)
{
  emExiPrintStruct(emberExiWattHourStructData,
                   (int8u *) data,
                   0,
                   "WattHour",
                   emberExiQnames);
...
void emberExiToXmlStructWattHour(EmberExiGeneratedWattHour *data) {
  EXI_DEBUG1("Start to XML: WattHour\n");
  emberExiPrintfLine("<WattHour");
  emberExiPrintfLine(">");
  emberExiPrintfLine("  <multiplier>%d</multiplier>", data->multiplier);
  emberExiPrintfLine("  <value>%d</value>", data->value);
  emberExiPrintfLine("</WattHour>");
  EXI_DEBUG1("End to XML: WattHour\n");
}
