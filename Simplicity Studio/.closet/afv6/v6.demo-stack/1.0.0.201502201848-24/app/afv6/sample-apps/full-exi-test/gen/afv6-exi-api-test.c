...
void emberExiApiUnitTest(EmberExiGrammarSet *grammarSet, EmberExiBits *bits, int8u *outputBuffer) {
  ...
  assert(emberExiStructUnitTest("NotificationList",
                                EMBER_EXI_QNAME_NotificationList,
                                emberExiNotificationListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ResponseListLink",
                                EMBER_EXI_QNAME_ResponseListLink,
                                emberExiResponseListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ResponseSet",
                                EMBER_EXI_QNAME_ResponseSet,
                                emberExiResponseSetStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("FileLink",
                                EMBER_EXI_QNAME_FileLink,
                                emberExiFileLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ConnectStatusType",
                                EMBER_EXI_QNAME_ConnectStatusType,
                                emberExiConnectStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("InverterStatusType",
                                EMBER_EXI_QNAME_InverterStatusType,
                                emberExiInverterStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("LocalControlModeStatusType",
                                EMBER_EXI_QNAME_LocalControlModeStatusType,
                                emberExiLocalControlModeStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ManufacturerStatusType",
                                EMBER_EXI_QNAME_ManufacturerStatusType,
                                emberExiManufacturerStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("OperationalModeStatusType",
                                EMBER_EXI_QNAME_OperationalModeStatusType,
                                emberExiOperationalModeStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("StateOfChargeStatusType",
                                EMBER_EXI_QNAME_StateOfChargeStatusType,
                                emberExiStateOfChargeStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("StorageModeStatusType",
                                EMBER_EXI_QNAME_StorageModeStatusType,
                                emberExiStorageModeStatusTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("DERStatus",
                                EMBER_EXI_QNAME_DERStatus,
                                emberExiDERStatusStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DERLink",
                                EMBER_EXI_QNAME_DERLink,
                                emberExiDERLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DERProgramLink",
                                EMBER_EXI_QNAME_DERProgramLink,
                                emberExiDERProgramLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("FileStatus",
                                EMBER_EXI_QNAME_FileStatus,
                                emberExiFileStatusStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("MirrorReadingSet",
                                EMBER_EXI_QNAME_MirrorReadingSet,
                                emberExiMirrorReadingSetStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("MirrorMeterReading",
                                EMBER_EXI_QNAME_MirrorMeterReading,
                                emberExiMirrorMeterReadingStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("MirrorUsagePoint",
                                EMBER_EXI_QNAME_MirrorUsagePoint,
                                emberExiMirrorUsagePointStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("FixedPointType",
                                EMBER_EXI_QNAME_FixedPointType,
                                emberExiFixedPointTypeStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DemandResponseProgramLink",
                                EMBER_EXI_QNAME_DemandResponseProgramLink,
                                emberExiDemandResponseProgramLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("LoadShedAvailability",
                                EMBER_EXI_QNAME_LoadShedAvailability,
                                emberExiLoadShedAvailabilityStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ActiveFlowReservationListLink",
                                EMBER_EXI_QNAME_ActiveFlowReservationListLink,
                                emberExiActiveFlowReservationListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("AbstractFlowReservation",
                                EMBER_EXI_QNAME_AbstractFlowReservation,
                                emberExiAbstractFlowReservationStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("FlowReservationResponse",
                                EMBER_EXI_QNAME_FlowReservationResponse,
                                emberExiFlowReservationResponseStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("FlowReservationResponseList",
                                EMBER_EXI_QNAME_FlowReservationResponseList,
                                emberExiFlowReservationResponseListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("CurrentRMS",
                                EMBER_EXI_QNAME_CurrentRMS,
                                emberExiCurrentRMSStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("AmpereHour",
                                EMBER_EXI_QNAME_AmpereHour,
                                emberExiAmpereHourStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ApparentPower",
                                EMBER_EXI_QNAME_ApparentPower,
                                emberExiApparentPowerStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("ReactivePower",
                                EMBER_EXI_QNAME_ReactivePower,
                                emberExiReactivePowerStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("WattHour",
                                EMBER_EXI_QNAME_WattHour,
                                emberExiWattHourStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("DERCapability",
                                EMBER_EXI_QNAME_DERCapability,
                                emberExiDERCapabilityStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("SupportedLocale",
                                EMBER_EXI_QNAME_SupportedLocale,
                                emberExiSupportedLocaleStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ResponseList",
                                EMBER_EXI_QNAME_ResponseList,
                                emberExiResponseListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ServiceSupplierList",
                                EMBER_EXI_QNAME_ServiceSupplierList,
                                emberExiServiceSupplierListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("RateComponentLink",
                                EMBER_EXI_QNAME_RateComponentLink,
                                emberExiRateComponentLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("PriceResponseCfg",
                                EMBER_EXI_QNAME_PriceResponseCfg,
                                emberExiPriceResponseCfgStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DeviceCapabilityLink",
                                EMBER_EXI_QNAME_DeviceCapabilityLink,
                                emberExiDeviceCapabilityLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("MirrorMeterReadingList",
                                EMBER_EXI_QNAME_MirrorMeterReadingList,
                                emberExiMirrorMeterReadingListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("VoltageRMS",
                                EMBER_EXI_QNAME_VoltageRMS,
                                emberExiVoltageRMSStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("DERSettings",
                                EMBER_EXI_QNAME_DERSettings,
                                emberExiDERSettingsStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("SupportedLocaleList",
                                EMBER_EXI_QNAME_SupportedLocaleList,
                                emberExiSupportedLocaleListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("PriceResponse",
                                EMBER_EXI_QNAME_PriceResponse,
                                emberExiPriceResponseStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("Error",
                                EMBER_EXI_QNAME_Error,
                                emberExiErrorStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("EndDeviceLink",
                                EMBER_EXI_QNAME_EndDeviceLink,
                                emberExiEndDeviceLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("FlowReservationRequest",
                                EMBER_EXI_QNAME_FlowReservationRequest,
                                emberExiFlowReservationRequestStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("FlowReservationRequestList",
                                EMBER_EXI_QNAME_FlowReservationRequestList,
                                emberExiFlowReservationRequestListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("CustomerAccountLink",
                                EMBER_EXI_QNAME_CustomerAccountLink,
                                emberExiCustomerAccountLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DefaultDERControl",
                                EMBER_EXI_QNAME_DefaultDERControl,
                                emberExiDefaultDERControlStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("PriceResponseCfgList",
                                EMBER_EXI_QNAME_PriceResponseCfgList,
                                emberExiPriceResponseCfgListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("RespondableIdentifiedObject",
                                EMBER_EXI_QNAME_RespondableIdentifiedObject,
                                emberExiRespondableIdentifiedObjectStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("MirrorUsagePointList",
                                EMBER_EXI_QNAME_MirrorUsagePointList,
                                emberExiMirrorUsagePointListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("ResponseSetList",
                                EMBER_EXI_QNAME_ResponseSetList,
                                emberExiResponseSetListStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("Registration",
                                EMBER_EXI_QNAME_Registration,
                                emberExiRegistrationStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("NotificationListLink",
                                EMBER_EXI_QNAME_NotificationListLink,
                                emberExiNotificationListLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();

  assert(emberExiStructUnitTest("MeterReadingLink",
                                EMBER_EXI_QNAME_MeterReadingLink,
                                emberExiMeterReadingLinkStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
  ...
  assert(emberExiStructUnitTest("DERAvailability",
                                EMBER_EXI_QNAME_DERAvailability,
                                emberExiDERAvailabilityStructData,
                                grammarSet, bits, outputBuffer,
                                exiUnitTestChildCount)
         == EMBER_EXI_STATUS_OK);
  dot();
