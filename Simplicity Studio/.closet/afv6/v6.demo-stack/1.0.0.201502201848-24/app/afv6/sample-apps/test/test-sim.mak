...
INCLUDES= \
  ...
  -Iapp/afv6/sample-apps/test/gen \
...
DEFINES= \
  ...
  -DCONFIGURATION_HEADER=\"app/afv6/sample-apps/test/gen/afv6-config.h\" \
...
APPLICATION_FILES= \
  ...
  app/afv6/sample-apps/test/gen/afv6-uri-mapper.c \
  app/afv6/sample-apps/test/gen/afv6-exi-api.c \
  app/afv6/sample-apps/test/gen/afv6-events.c \
  app/afv6/sample-apps/test/gen/afv6-callback-stubs.c \
  app/afv6/sample-apps/test/gen/afv6-callbacks.c \
 \
...
OUTPUT_DIR= build/afv6-test-unix-simulation
...
$(OUTPUT_DIR)/%.o: app/afv6/sample-apps/test/gen/%.c $(OUTPUT_DIR_CREATED)
	$(CC) $(CPPFLAGS) -c $< -o $(OUTPUT_DIR)/$(@F)
