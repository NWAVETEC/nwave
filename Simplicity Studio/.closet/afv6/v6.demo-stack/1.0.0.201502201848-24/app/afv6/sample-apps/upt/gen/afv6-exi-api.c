...
#define EMBER_EXI_STRUCT EmberExiGeneratedAbstractDevice // index 1
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_AbstractDevice, 2, 0, 1141, 66, 0),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedActiveTextMessageListLink // index 79
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ActiveTextMessageListLink, 2, 0, 619, 6, 3),
#undef EMBER_EXI_STRUCT
...
#define EMBER_EXI_STRUCT EmberExiGeneratedCondition // index 106
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Condition, 0, 0, 65535, 15, 8),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConfiguration // index 121
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Configuration, 2, 0, 1141, 30, 9),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedConfigurationLink // index 151
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ConfigurationLink, 1, 0, 595, 6, 10),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedCustomerAccountListLink // index 157
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_CustomerAccountListLink, 2, 0, 619, 6, 12),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERListLink // index 163
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERListLink, 2, 0, 619, 6, 13),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDERProgramListLink // index 169
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DERProgramListLink, 2, 0, 619, 6, 14),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDRLCCapabilities // index 175
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DRLCCapabilities, 0, 0, 65535, 21, 15),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDateTimeInterval // index 196
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DateTimeInterval, 0, 0, 65535, 12, 17),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDemandResponseProgramListLink // index 208
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DemandResponseProgramListLink, 2, 0, 619, 6, 18),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceCapability // index 214
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceCapability, 1, 10, 502, 24, 19),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceInformation // index 238
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceInformation, 1, 0, 1009, 54, 21),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceInformationLink // index 292
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceInformationLink, 1, 0, 595, 6, 22),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceStatus // index 298
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceStatus, 1, 0, 1009, 30, 23),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedDeviceStatusLink // index 328
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DeviceStatusLink, 1, 0, 595, 6, 24),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedDrResponse // index 334
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_DrResponse, 1, 4, 1060, 39, 25),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceList // index 418
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceList, 4, 0, 1123, 12, 29),
    EMBER_EXI_SUBSTRUCT_ARRAY(EndDevice, 0, 255, EndDevice, EmberExiGeneratedEndDevice, emberExiEndDeviceStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEndDeviceListLink // index 430
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EndDeviceListLink, 2, 0, 619, 6, 30),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedEvent // index 436
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Event, 4, 3, 1033, 21, 31),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedEventStatus // index 457
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_EventStatus, 0, 0, 65535, 21, 32),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFileListLink // index 478
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileListLink, 2, 0, 619, 6, 33),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFileStatusLink // index 484
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FileStatusLink, 1, 0, 595, 6, 34),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationRequestListLink // index 490
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationRequestListLink, 2, 0, 619, 6, 36),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFlowReservationResponseListLink // index 496
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FlowReservationResponseListLink, 2, 0, 619, 6, 37),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignmentsBase // index 502
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignmentsBase, 1, 0, 1009, 66, 38),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedFunctionSetAssignmentsListLink // index 568
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_FunctionSetAssignmentsListLink, 2, 0, 619, 6, 39),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIPInterfaceListLink // index 574
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IPInterfaceListLink, 2, 0, 619, 6, 40),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedIdentifiedObject // index 580
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_IdentifiedObject, 1, 0, 1009, 15, 41),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedLink // index 595
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Link, 0, 0, 65535, 9, 43),
    EMBER_EXI_AT_STRING(href, STRING, 255, href),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedList // index 604
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_List, 0, 0, 1009, 15, 44),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedListLink // index 619
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ListLink, 0, 0, 595, 12, 45),
    EMBER_EXI_AT(all, UNSIGNED_INTEGER, 255, all),
    EMBER_EXI_AT_STRING(href, STRING, 255, href),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLoadShedAvailabilityLink // index 631
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LoadShedAvailabilityLink, 1, 0, 595, 6, 46),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedLogEventListLink // index 637
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_LogEventListLink, 2, 0, 619, 6, 48),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgram // index 643
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgram, 2, 3, 1108, 24, 49),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgramList // index 667
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgramList, 4, 0, 1123, 12, 50),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMessagingProgramListLink // index 679
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MessagingProgramListLink, 2, 0, 619, 6, 51),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReading // index 685
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReading, 1, 3, 715, 30, 52),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingBase // index 715
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingBase, 1, 3, 580, 6, 53),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingList // index 721
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingList, 4, 0, 1123, 12, 54),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedMeterReadingListLink // index 733
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MeterReadingListLink, 2, 0, 619, 6, 55),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedMirrorUsagePointListLink // index 739
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_MirrorUsagePointListLink, 2, 0, 619, 6, 56),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedNotification // index 745
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Notification, 1, 1, 1177, 21, 57),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedOffset // index 766
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Offset, 0, 0, 65535, 15, 58),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPowerConfiguration // index 781
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PowerConfiguration, 0, 0, 65535, 12, 61),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedPowerStatusLink // index 793
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PowerStatusLink, 1, 0, 595, 6, 64),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPrepaymentListLink // index 799
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PrepaymentListLink, 2, 0, 619, 6, 65),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedPriceResponseCfgListLink // index 805
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_PriceResponseCfgListLink, 2, 0, 619, 6, 66),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRateComponentListLink // index 811
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RateComponentListLink, 2, 0, 619, 6, 69),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReading // index 817
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Reading, 0, 5, 832, 15, 70),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(subscribable, UNSIGNED_INTEGER, 4, subscribable_option),
    EMBER_EXI_CH(localID, BINARY, 5, localID_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingBase // index 832
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingBase, 1, 0, 1009, 24, 71),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingLink // index 856
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingLink, 1, 0, 595, 6, 72),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingList // index 862
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingList, 4, 0, 1123, 12, 73),
    EMBER_EXI_SUBSTRUCT_ARRAY(Reading, 0, 255, Reading, EmberExiGeneratedReading, emberExiReadingStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingListLink // index 874
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingListLink, 2, 0, 619, 6, 74),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSet // index 880
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSet, 1, 4, 892, 12, 75),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetBase // index 892
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetBase, 1, 3, 580, 12, 76),
    EMBER_EXI_SUBSTRUCT(timePeriod, 1, 0, timePeriod, EmberExiGeneratedDateTimeInterval, emberExiDateTimeIntervalStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetList // index 904
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetList, 4, 0, 1123, 12, 77),
    EMBER_EXI_SUBSTRUCT_ARRAY(ReadingSet, 0, 255, ReadingSet, EmberExiGeneratedReadingSet, emberExiReadingSetStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingSetListLink // index 916
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingSetListLink, 2, 0, 619, 6, 78),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedReadingType // index 922
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingType, 1, 0, 1009, 63, 79),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedReadingTypeLink // index 985
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ReadingTypeLink, 1, 0, 595, 6, 80),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRealEnergy // index 991
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RealEnergy, 0, 0, 65535, 12, 81),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(value, UNSIGNED_INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRegistrationLink // index 1003
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RegistrationLink, 1, 0, 595, 6, 82),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedResource // index 1009
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Resource, 0, 0, 65535, 9, 83),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRespondableResource // index 1018
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RespondableResource, 0, 0, 1009, 15, 84),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT_STRING(replyTo, STRING, 0, replyTo_option),
    EMBER_EXI_AT(responseRequired, BINARY, 0, responseRequired_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedRespondableSubscribableIdentifiedObject // index 1033
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_RespondableSubscribableIdentifiedObject, 0, 0, 1018, 27, 85),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT_STRING(replyTo, STRING, 0, replyTo_option),
    EMBER_EXI_AT(responseRequired, BINARY, 0, responseRequired_option),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedResponse // index 1060
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Response, 1, 0, 1009, 18, 86),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedResponseSetListLink // index 1078
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_ResponseSetListLink, 2, 0, 619, 6, 87),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSelfDevice // index 1084
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SelfDevice, 2, 11, 1, 6, 90),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSelfDeviceLink // index 1090
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SelfDeviceLink, 1, 0, 595, 6, 91),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSetPoint // index 1096
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SetPoint, 0, 0, 65535, 12, 93),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableIdentifiedObject // index 1108
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableIdentifiedObject, 2, 0, 1141, 15, 94),
    EMBER_EXI_CH(mRID, BINARY, 255, mRID),
    EMBER_EXI_CH_STRING(description, STRING, 0, description_option),
    EMBER_EXI_CH(version, UNSIGNED_INTEGER, 1, version_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableList // index 1123
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableList, 0, 0, 1141, 18, 95),
    EMBER_EXI_AT(all, UNSIGNED_INTEGER, 255, all),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(results, UNSIGNED_INTEGER, 255, results),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscribableResource // index 1141
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscribableResource, 0, 0, 1009, 12, 96),
    EMBER_EXI_AT_STRING(href, STRING, 0, href_option),
    EMBER_EXI_AT(subscribable, UNSIGNED_INTEGER, 0, subscribable_option),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscription // index 1153
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Subscription, 1, 1, 1177, 24, 97),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionBase // index 1177
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionBase, 1, 0, 1009, 9, 98),
    EMBER_EXI_CH_STRING(subscribedResource, STRING, 255, subscribedResource),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionList // index 1186
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionList, 3, 0, 604, 12, 99),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedSubscriptionListLink // index 1198
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SubscriptionListLink, 2, 0, 619, 6, 100),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedSupportedLocaleListLink // index 1204
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_SupportedLocaleListLink, 2, 0, 619, 6, 101),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTariffProfileListLink // index 1210
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TariffProfileListLink, 2, 0, 619, 6, 103),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTemperature // index 1216
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Temperature, 0, 0, 65535, 15, 104),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(subject, UNSIGNED_INTEGER, 255, subject),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessage // index 1231
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessage, 4, 6, 436, 15, 105),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessageList // index 1246
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessageList, 4, 0, 1123, 12, 106),
    EMBER_EXI_SUBSTRUCT_ARRAY(TextMessage, 0, 255, TextMessage, EmberExiGeneratedTextMessage, emberExiTextMessageStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextMessageListLink // index 1258
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextMessageListLink, 2, 0, 619, 6, 107),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTextResponse // index 1264
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TextResponse, 1, 4, 1060, 6, 108),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedTime // index 1270
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_Time, 1, 0, 1009, 27, 109),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeConfiguration // index 1297
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeConfiguration, 0, 0, 65535, 18, 110),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedTimeLink // index 1315
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_TimeLink, 1, 0, 595, 6, 111),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUnitValueType // index 1321
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UnitValueType, 0, 0, 65535, 15, 115),
    EMBER_EXI_CH(multiplier, INTEGER, 255, multiplier),
    EMBER_EXI_CH(unit, UNSIGNED_INTEGER, 255, unit),
    EMBER_EXI_CH(value, INTEGER, 255, value),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePoint // index 1336
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePoint, 1, 6, 1348, 12, 117),
...
#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointBase // index 1348
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointBase, 1, 3, 580, 15, 118),
    EMBER_EXI_CH(roleFlags, BINARY, 255, roleFlags),
    EMBER_EXI_CH(serviceCategoryKind, UNSIGNED_INTEGER, 255, serviceCategoryKind),
    EMBER_EXI_CH(status, UNSIGNED_INTEGER, 255, status),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointList // index 1363
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointList, 4, 0, 1123, 12, 119),
    EMBER_EXI_SUBSTRUCT_ARRAY(UsagePoint, 0, 255, UsagePoint, EmberExiGeneratedUsagePoint, emberExiUsagePointStructDataIndex),
#undef EMBER_EXI_STRUCT

#define EMBER_EXI_STRUCT EmberExiGeneratedUsagePointListLink // index 1375
    EMBER_EXI_FIELD_START(EMBER_EXI_QNAME_UsagePointListLink, 2, 0, 619, 6, 120),
#undef EMBER_EXI_STRUCT
