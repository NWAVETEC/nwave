...
INCLUDES= \
  ...
  -I./app/afv6/plugin/netstat-client \
  ...
  -Iapp/afv6/sample-apps/client-3588/gen \
...
DEFINES= \
  ...
  -DCONFIGURATION_HEADER=\"app/afv6/sample-apps/client-3588/gen/afv6-config.h\" \
...
APPLICATION_FILES= \
  ...
  app/afv6/plugin/netstat-client/netstat-client.c \
  ...
  app/afv6/sample-apps/client-3588/gen/afv6-uri-mapper.c \
  app/afv6/sample-apps/client-3588/gen/afv6-exi-api.c \
  app/afv6/sample-apps/client-3588/gen/afv6-events.c \
  app/afv6/sample-apps/client-3588/gen/afv6-callback-stubs.c \
  app/afv6/sample-apps/client-3588/gen/afv6-callbacks.c \
 \
...
OUTPUT_DIR= build/afv6-client-3588-ecc-unix-simulation
...
APP_FILE= $(OUTPUT_DIR)/afv6-client-3588-ecc
...
$(OUTPUT_DIR)/%.o: app/afv6/plugin/netstat-client/%.c $(OUTPUT_DIR_CREATED)
	$(CC) $(CPPFLAGS) -c $< -o $(OUTPUT_DIR)/$(@F)
...
$(OUTPUT_DIR)/%.o: app/afv6/sample-apps/client-3588/gen/%.c $(OUTPUT_DIR_CREATED)
	$(CC) $(CPPFLAGS) -c $< -o $(OUTPUT_DIR)/$(@F)
